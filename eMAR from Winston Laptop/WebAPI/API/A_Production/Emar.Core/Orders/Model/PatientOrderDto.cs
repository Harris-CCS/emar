...
namespace Emar.Core.Orders.Model
{
    public class PatientOrderDto : OrderBase
    {
        ...
        //Whether or not this order needs to be cosigned.
        //This is not stored in the DB but will be calculated.
        //If this order has not been cosigned yet...
        //  If the patient is younger than 13 or
        //  the order's medication_id is found in the medications_high_risk table
        //    Then CosignNeeded = true
        //  Else
        //    CosignNeeded = false
        //  End If
        //Else
        //  CoSignNeeded = false
        //End If
        //Winston Murdock, 11/08/2021.  PC-26735 and PC-26739
        public bool CosignNeeded { get; set; }
    }
}