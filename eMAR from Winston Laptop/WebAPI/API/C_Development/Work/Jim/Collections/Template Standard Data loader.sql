...
from   (values
			...
			,('SubcutanMedication', 10, 'Date of publication', 1, 'Date', NULL, 0, NULL, NULL, 1, '^Cdate of publication:^im^^^medsvc_vac_pubdate=')
			,('SubcutanMedication', 11, 'Name of publication', 1, 'FreeText', NULL, 0, NULL, NULL, 1, '^Cname of publication:^^^^medsvc_vac_pubname=')
			,('SubcutanMedication', 12, 'Manufacturer', 1, 'FreeText', NULL, 0, NULL, NULL, 1, '^Cmanufacturer:^^^^medsvc_vac_manuf=')
			,('SubcutanMedication', 13, 'Lot number', 1, 'FreeText', NULL, 0, NULL, NULL, 1, '^Clot number:^^^^medsvc_vac_lot=')
			,('SubcutanMedication', 14, 'Expiration', 1, 'Date', NULL, 0, NULL, NULL, 1, '^Cexpiration:^intram^^^medsvc_vac_exp=')
			,('SubcutanMedication', 15, 'Dose number', 1, 'DropDownListBox', NULL, 0, NULL, NULL, 1, '')
			,('SubcutanMedication', 16, 'Other dose number', 1, 'FreeText', NULL, 0, NULL, NULL, 1, '^C^^^^medsvc_vac_dosenum=')
			,('SubcutanMedication', 17, 'Previous dose confirmed by', 1, 'DropDownListBox', NULL, 0, NULL, NULL, 1, '')
			...
			,('IntraMuscMedication', 4, 'Other site ~~(non-antibiotic/immunization)', 1, 'FreeText', NULL, 0, NULL, NULL, 1, '^CMedication administered to ^IV_Location=')
			...
			,('INtraMuscMedication', 18, 'Dose number', 1, 'DropDownListBox', NULL, 0, NULL, NULL, 1, '')
