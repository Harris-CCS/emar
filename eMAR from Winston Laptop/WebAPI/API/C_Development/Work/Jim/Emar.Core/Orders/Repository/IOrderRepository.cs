...
namespace Emar.Core.Orders.Repository
{
    public interface IOrderRepository
    {
        ...
        List<OrderAdministration> GetAllPastDueAdministrationsForPatient(long patientId);
        ...
        List<GroupListItem> GetGroupItemsByGroupName(string departmentCode, BaseLinkResource resource, string groupNameForFilter);
        ...
        int GetCodeShareSites(int sourceSiteId, OrderRepository.CodeShareEntity entity);
    }
}