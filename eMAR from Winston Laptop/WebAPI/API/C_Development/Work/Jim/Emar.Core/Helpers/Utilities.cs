...
namespace Emar.Core.Helpers
{
    ...
    public static class Utilities
    {
        ...
        public static void LogError(string patIbex, byte externalSiteId, long patientOrderId, long adminId, string errMessage, string action = null)
        {
            //Log any error.
    ...
    public static class DateTimeOffsetExtensions
    {
        ...
        public static DateTimeOffset TimeAdjustedForTimeZone(string siteTimeZone, DateTimeOffset tzo)
        {
            ...
            if (tz == null)
                throw new ArgumentException(
                    "Invalid Timezone passed to DateTimeOffsetExtensions.TimeAdjustedForTimeZone()",
                    nameof(siteTimeZone));
