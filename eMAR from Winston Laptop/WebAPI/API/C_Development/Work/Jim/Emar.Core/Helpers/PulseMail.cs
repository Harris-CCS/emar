...
namespace Emar.Core.Helpers
{
    ...
    public class PulseMail
    {
        ...
        /// <param name="rand">Supplied random number</param>
        ...
        public bool SendMessage(int to, string subject, string message, int from, string rand = "", byte otherSite = 0, bool returnReceipt = false)
        {
            ClearErrors();
            ...
            string mailFile = string.IsNullOrEmpty(rand) ? RandomCharacters() : rand;
