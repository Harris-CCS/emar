...
namespace Emar.Core.Medications.Repository
{
    public class InteractionRepository : IInteractionRepository
    {
        ...
        /// Whether or not we want to deleting any existing interactions before inserting new ones.  Defaults to false.
        /// </param>
        /// <returns>Boolean success/failure</returns>
        public bool RecordNewInteractionsReactions(IEnumerable<MedicationInteractionReaction> medicationInteractionsReactions, long orderId,
            EmarOrderType orderType, bool insertOnly = true, bool? deleteExisting = false)
        {
            int i;
            ...
            try
            {
                ...
                else 
                {
                    ...
                    else
                    {
                        ...
                        //Only do deletes, if specified.
                        //Winston Murdock, 06/02/2022.  PC-27309
                        if (deleteExisting.HasValue)
                        {
                            if ((bool)deleteExisting)
                            {
                                // Now handle removals
                                ...
                                } //end foreach current Interaction
                            } //end if deleteExisting
                        } //end if deleteExisting Has Value
                    }
