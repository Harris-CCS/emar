...
from   (values
			...
			,(49, 'CoSign', 'Co-Sign')
			,(50, 'PreMedication', 'Pre Medication')
       ) as [items]
       ([id], [name], [title]);
...
from   (values
			...
			,('Intramuscular', 1, 'PreMedication', 0)
			,('Intramuscular', 2, 'IntraMuscMedication', 0)
			,('Intramuscular', 3, 'Assessment', 0)
			,('Intramuscular', 4, 'Emotional', 0)
			,('Intramuscular', 5, 'Safety', 0)
			,('Intramuscular', 6, 'GenericGive', 0)
            ,('Oral', 1, 'PreMedication', 0)
			,('Oral', 2, 'OralMedication', 0)
			,('Oral', 3, 'Emotional', 0)
			,('Oral', 4, 'Safety', 0)
			,('Oral', 5, 'GenericGive', 0)
			,('GenericGive', 1, 'DefaultGive', 0)
			,('GenericGive', 2, 'GenericGive', 0)
			,('Enteral', 1, 'PreMedication', 0)
			,('Enteral', 2, 'EnteralMedication', 0)
			,('Enteral', 3, 'Emotional', 0)
			,('Enteral', 4, 'AmbulateSafety', 0)
			,('Enteral', 5, 'GenericGive', 0)
			,('Eye', 1, 'PreMedication', 0)
			,('Eye', 2, 'EyeMedication', 0)
			,('Eye', 3, 'Emotional', 0)
			,('Eye', 4, 'AmbulateSafety', 0)
			,('Eye', 5, 'GenericGive', 0)
			,('Nasal', 1, 'PreMedication', 0)
			,('Nasal', 2, 'NasalMedication', 0)
			,('Nasal', 3, 'Emotional', 0)
			,('Nasal', 4, 'Safety', 0)
			,('Nasal', 5, 'GenericGive', 0)
			,('Inhalation', 1, 'PreMedication', 0)
			,('Inhalation', 2, 'InhalationMedication', 0)
			,('Inhalation', 3, 'InhalationAssessment', 0)
			,('Inhalation', 4, 'Emotional', 0)
			,('Inhalation', 5, 'Safety', 0)
			,('Inhalation', 6, 'GenericGive', 0)
			,('Intradermal', 1, 'PreMedication', 0)
			,('Intradermal', 2, 'IntraDermMedication', 0)
			,('Intradermal', 3, 'Emotional', 0)
			,('Intradermal', 4, 'Safety', 0)
			,('Intradermal', 5, 'GenericGive', 0)
			,('Intraosseous', 1, 'PreMedication', 0)
			,('Intraosseous', 2, 'IntraOssMedication', 0)
			,('Intraosseous', 3, 'IntraOssAssessment', 0)
			,('Intraosseous', 4, 'Emotional', 0)
			,('Intraosseous', 5, 'Safety', 0)
			,('Intraosseous', 6, 'GenericGive', 0)
			,('Rectal', 1, 'PreMedication', 0)
			,('Rectal', 2, 'RectalMedication', 0)
			,('Rectal', 3, 'Emotional', 0)
			,('Rectal', 4, 'Safety', 0)
			,('Rectal', 5, 'GenericGive', 0)
			,('Transdermal', 1, 'PreMedication', 0)
			,('Transdermal', 2, 'TransDermMedication', 0)
			,('Transdermal', 3, 'Emotional', 0)
			,('Transdermal', 4, 'AmbulateSafety', 0)
			,('Transdermal', 5, 'GenericGive', 0)
			,('Vaginal', 1, 'PreMedication', 0)
			,('Vaginal', 2, 'VaginalMedication', 0)
			,('Vaginal', 3, 'Emotional', 0)
			,('Vaginal', 4, 'AmbulateSafety', 0)
			,('Vaginal', 5, 'GenericGive', 0)
			,('Subcutaneous', 1, 'PreMedication', 0)
			,('Subcutaneous', 2, 'SubcutanMedication', 0)
			,('Subcutaneous', 3, 'Emotional', 0)
			,('Subcutaneous', 4, 'AmbulateSafety', 0)
			,('Subcutaneous', 5, 'GenericGive', 0)
			,('Intravenous', 1, 'PreMedication', 0)
			,('Intravenous', 2, 'IVMedication', 0)
			,('Intravenous', 3, 'IVAssessment', 0)
			,('Intravenous', 4, 'IVSafety', 0)
			,('Intravenous', 5, 'Emotional', 0)
			,('Intravenous', 6, 'GenericGive', 0)
			...
			,('IntravenousInI', 1, 'PreMedication', 0)
			,('IntravenousInI', 2, 'IVInIMedication', 0)
			,('IntravenousInI', 3, 'IVInIAssessment', 0)
			,('IntravenousInI', 4, 'IVInISafety', 0)
			,('IntravenousInI', 5, 'IVInIEmotional', 0)
			,('IntravenousInI', 6, 'GenericGive', 0)
...
from   (values
			...
			,('IVInIMedication', 4, 'Amount wasted', 1, 'FreeText', NULL, 0, NULL, NULL, 1, '^CAmount wasted:=')
			,('IVInIMedication', 5, 'Location', 1, 'DropDownListBox', NULL, 1, NULL, 'true', 1, '')
			,('IVInIMedication', 6, 'Other IV Site', 1, 'FreeText', NULL, 0, NULL, NULL, 1, '^Cinto^IV_Location=')
			,('IVInIMedication', 7, 'IV Number', 1, 'DropDownListBox', NULL, 1, NULL, 'true', 1, '')
			...
			,('IVMedication', 3, 'Amount wasted', 1, 'FreeText', NULL, 0, NULL, NULL, 1, '^CAmount wasted:=')
			,('IVMedication', 4, 'IV number', 1, 'DropDownListBox', NULL, 1, NULL, 'true', 1, NULL)
			,('IVMedication', 5, 'Location', 1, 'DropDownListBox', NULL, 1, NULL, 'true', 1, NULL)
			,('IVMedication', 6, 'Other Location', 1, 'FreeText', NULL, 0, NULL, NULL, 1, '^CIV SITE into^IV_Location+')
			,('IVMedication', 7, 'ETT', 1, 'CheckBox', NULL, 0, NULL, 'true', 1, '^D^ETT^QX556=Medication administered via Endotracheal tube')	
			,('IVMedication', 8, 'No IV', 1, 'CheckBox', NULL, 0, NULL, NULL, 1, '^D=no IV')		
			,('IVMedication', 9, 'IV infiltrated', 1, 'CheckBox', NULL, 0, NULL, NULL, 1, '^D=IV infiltrated')	
														
			,('IVMedication', 10, 'IV Fluids', 1, 'CheckBox', NULL, 0, NULL, 'true', 1, '')
			,('IVMedication', 11, 'Site', 1, 'DropDownListBox', NULL, 1, NULL, 'true', 1, NULL)
			,('IVMedication', 12, 'Bag number', 1, 'DropDownListBox', NULL, 0, NULL, 'true', 1, NULL)
			,('IVMedication', 13, 'Amount', 1, 'DropDownListBox', NULL, 0, NULL, 'true', 1, NULL)
			,('IVMedication', 14, 'Bolus', 1, 'Label', NULL, 0, NULL, NULL, 1, NULL)
			,('IVMedication', 15, 'Bolus amount', 1, 'DropDownListBox', NULL, 0, NULL, 'true', 1, NULL)
			,('IVMedication', 16, 'Other bolus amount (ml)', 1, 'FreeText', NULL, 0, NULL, NULL, 1, '^COther Bolus Amount (ml):=')
			,('IVMedication', 17, 'Rate of bolus', 1, 'CheckBox', NULL, 0, NULL, 'true', 1, '^D^bolus=Rate of bolus:')
			,('IVMedication', 18, 'Wide open', 1, 'CheckBox', NULL, 0, NULL, NULL, 1, '^D=wide open')
			,('IVMedication', 19, '1000 ml/hr', 1, 'CheckBox', NULL, 0, NULL, NULL, 1, '^D=1000 ml/hr')
			,('IVMedication', 20, '500 ml/hr', 1, 'CheckBox', NULL, 0, NULL, NULL, 1, '^D=500 ml/hr')
			,('IVMedication', 21, '250 ml/hr', 1, 'CheckBox', NULL, 0, NULL, NULL, 1, '^D=250 ml/hr')
			,('IVMedication', 22, 'Other rate >>', 1, 'CheckBox', NULL, 0, NULL, 'true', 1, '^D=Other rate of bolus:')
			,('IVMedication', 23, 'Other rate of bolus (ml/hr)', 1, 'FreeText', NULL, 0, NULL, NULL, 1, '^COther rate of bolus (ml/hr):=')
			,('IVMedication', 24, 'Rate after bolus', 1, 'DropDownListBox', NULL, 0, NULL, 'true', 1, NULL)
			,('IVMedication', 25, 'Repeat bolus', 1, 'DropDownListBox', NULL, 0, NULL, 'true', 1, NULL)
			,('IVMedication', 26, 'Other repeat bolus (ml)', 1, 'FreeText', NULL, 0, NULL, NULL, 1, '^COther repeat bolus (ml):=')
			
			,('IVMedication', 27, 'Rate of infusion (non-bolus)', 1, 'Label', NULL, 0, NULL, NULL, 1, NULL)
			,('IVMedication', 28, 'Rate', 1, 'DropDownListBox', NULL, 0, NULL, 'true', 1, NULL)
			,('IVMedication', 29, 'Other rate (ml/hr)', 1, 'FreeText', NULL, 0, NULL, NULL, 1, '^COther infusion rate (ml/hr):=')
			,('IVMedication', 30, 'Rate change', 1, 'DropDownListBox', NULL, 0, NULL, 'true', 1, NULL)
			,('IVMedication', 31, 'Other rate change (ml/hr)', 1, 'FreeText', NULL, 0, NULL, NULL, 1, '^COther rate change (ml/hr):=')
			
			,('IVMedication', 32, 'Tubing', 1, 'Label', NULL, 0, NULL, NULL, 1, NULL)
			,('IVMedication', 33, 'Primary tubing', 1, 'CheckBox', NULL, 0, NULL, NULL, 1, '^D^^QX1748=via primary tubing')
			,('IVMedication', 34, 'Gravity tubing', 1, 'CheckBox', NULL, 0, NULL, NULL, 1, '^D^^QX424=via gravity tubing')
			,('IVMedication', 35, 'Blood tubing', 1, 'CheckBox', NULL, 0, NULL, NULL, 1, '^D^^QX423=via blood tubing')
			,('IVMedication', 36, 'Pump tubing', 1, 'CheckBox', NULL, 0, NULL, NULL, 1, '^D^^QX1493=via pump tubing')
			,('IVMedication', 37, 'Secondary tubing', 1, 'CheckBox', NULL, 0, NULL, NULL, 1, '^D^^QX425=via secondary tubing')
			,('IVMedication', 38, 'In buretrol (Tubing)', 1, 'CheckBox', NULL, 0, NULL, 'true', 1, '^D^^QX422=via Buretrol')
			,('IVMedication', 39, 'Initial fluid (ml)', 1, 'FreeText', NULL, 0, NULL, NULL, 1, '^Cinitial fluid (ml):=')
			,('IVMedication', 40, 'Additional fluid (ml)', 1, 'FreeText', NULL, 0, NULL, NULL, 1, '^Cadditional fluid (ml):=')	
				
			,('IVMedication', 41, 'Pump', 1, 'Label', NULL, 0, NULL, NULL, 1, NULL)
			,('IVMedication', 42, 'On IV pump', 1, 'CheckBox', NULL, 0, NULL, NULL, 1, '^D^^QX421=on IV pump')
			,('IVMedication', 43, 'Syringe pump', 1, 'CheckBox', NULL, 0, NULL, NULL, 1, '^D^^QX6402=on syringe pump')
			,('IVMedication', 44, 'Rapid infuser pump', 1, 'CheckBox', NULL, 0, NULL, NULL, 1, '^D^^QX299=via rapid infuser')
			,('IVMedication', 45, 'Fluid warmer pump', 1, 'CheckBox', NULL, 0, NULL, NULL, 1, '^D^^QX298=Fluid warmer used')
			
			,('IVMedication', 46, 'Tubing changed', 1, 'Label', NULL, 0, NULL, NULL, 1, NULL)
			,('IVMedication', 47, 'Pump tubing changed', 1, 'CheckBox', NULL, 0, NULL, NULL, 1, '^D^^QX1493^=Tubing changed to pump tubing')
			,('IVMedication', 48, 'In buretrol tubing changed', 1, 'CheckBox', NULL, 0, NULL, NULL, 1, '^D^^QX422^=Tubing changed to in Buretrol')
			,('IVMedication', 49, 'Blood tubing changed', 1, 'CheckBox', NULL, 0, NULL, NULL, 1, '^D^^QX423^=Tubing changed to blood tubing')
			,('IVMedication', 50, 'Gravity tubing changed', 1, 'CheckBox', NULL, 0, NULL, NULL, 1, '^D^^QX424^=Tubing changed to gravity tubing')
			,('IVMedication', 51, 'Secondary tubing changed', 1, 'CheckBox', NULL, 0, NULL, NULL, 1, '^D^^QX425^=Tubing changed to secondary tubing')
			
			,('IVMedication', 52, 'IVP', 1, 'CheckBox', NULL, 0, NULL, 'true', 1, '^D^^QX116=IVP')
			,('IVMedication', 53, 'Initial (First medication given IVP)', 1, 'CheckBox', NULL, 0, NULL, 'true', 1, '^D^^QX6279=initial medication')
			,('IVMedication', 54, 'Slowly (Initial)', 1, 'CheckBox', NULL, 0, NULL, NULL, 1, '^D=Slowly')
			,('IVMedication', 55, 'Rapidly (Initial)', 1, 'CheckBox', NULL, 0, NULL, NULL, 1, '^D=Rapidly')
			,('IVMedication', 56, 'Subsequent (Each different medication given IVP after initial medication IVP)', 1, 'CheckBox', NULL, 0, NULL, 'true', 1, '^D^^QX4594=subsequent different medication')
			,('IVMedication', 57, 'Slowly (Subsequent)', 1, 'CheckBox', NULL, 0, NULL, NULL, 1, '^D=Slowly')
			,('IVMedication', 58, 'Rapidly (Subsequent)', 1, 'CheckBox', NULL, 0, NULL, NULL, 1, '^D=Rapidly')
			,('IVMedication', 59, 'Repeat (Repeat dose of previous medication given)', 1, 'CheckBox', NULL, 0, NULL, 'true', 1, '^D^^QX6268=repeat same medication')
			,('IVMedication', 60, 'Slowly (Repeat)', 1, 'CheckBox', NULL, 0, NULL, NULL, 1, '^D=Slowly')
			,('IVMedication', 61, 'Rapidly (Repeat)', 1, 'CheckBox', NULL, 0, NULL, NULL, 1, '^D=Rapidly')
			
			,('IVMedication', 62, 'Added to existing IV fluid', 1, 'CheckBox', NULL, 0, NULL, 'true', 1, '^D^IVadd^QX1036=added to existing IV Fluid')
			,('IVMedication', 63, 'Type', 1, 'FreeText', NULL, 0, NULL, NULL, 1, '^CType:^type=')
			,('IVMedication', 64, 'Amount of fluid remaining', 1, 'FreeText', NULL, 0, NULL, NULL, 1, '^CAmount of fluid remaining:^amont=')
			
			,('IVMedication', 65, 'IVPB/drip', 1, 'CheckBox', NULL, 0, NULL, 'true', 1, '^D^drip=IVPB or drip')
			,('IVMedication', 66, 'IVPB/drip type', 1, 'DropDownListBox', 'Initial (1st medication infusion this IV site)', 0, NULL, 'true', 1, '')
			,('IVMedication', 67, 'Premixed', 1, 'CheckBox', NULL, 0, NULL, NULL, 1, '^D=Premixed')
			,('IVMedication', 68, 'IVPB mixed in', 1, 'DropDownListBox', NULL, 0, NULL, 'true', 1, NULL)
			,('IVMedication', 69, 'Other IVPB mixed in', 1, 'FreeText', NULL, 0, NULL, NULL, 1, '^COther IVPB mixed in:^other=')
			,('IVMedication', 70, 'Fluid', 1, 'DropDownListBox', NULL, 0, NULL, 'true', 1, NULL)
			,('IVMedication', 71, 'IVPB/drip tubing', 1, 'Label', NULL, 0, NULL, NULL, 1, NULL)
			,('IVMedication', 72, 'Primary IVPB/drip tubing', 1, 'CheckBox', NULL, 0, NULL, NULL, 1, '^D^^QX1748=via primary tubing')
			,('IVMedication', 73, 'Gravity IVPB/drip tubing', 1, 'CheckBox', NULL, 0, NULL, NULL, 1, '^D^^QX424=via gravity tubing')
			,('IVMedication', 74, 'Blood IVPB/drip tubing', 1, 'CheckBox', NULL, 0, NULL, NULL, 1, '^D^^QX423=via blood tubing')
			,('IVMedication', 75, 'Pump IVPB/drip tubing', 1, 'CheckBox', NULL, 0, NULL, NULL, 1, '^D^^QX1493=via pump tubing')
			,('IVMedication', 76, 'On an IV pump', 1, 'CheckBox', NULL, 0, NULL, NULL, 1, '^D^^QX421=on an IV pump')
			,('IVMedication', 77, 'Secondary IVPB/drip tubing', 1, 'CheckBox', NULL, 0, NULL, NULL, 1, '^D^^QX425=via secondary tubing')
			,('IVMedication', 78, 'In buretrol (IVPB/drip Tubing)', 1, 'CheckBox', NULL, 0, NULL, NULL, 1, '^D^^QX422=via Buretrol')
			,('IVMedication', 79, 'Rate (IVPB/drip)', 1, 'DropDownListBox', NULL, 0, NULL, 'true', 1, NULL)
			,('IVMedication', 80, 'Pediatric rate (IVPB/drip)', 1, 'DropDownListBox', NULL, 0, NULL, 'true', 1, NULL)
			,('IVMedication', 81, 'Other rate (IVPB/drip)', 1, 'FreeText', NULL, 0, NULL, NULL, 1, '^COther rate at:=')
			,('IVMedication', 82, 'Filter Needle used with administration', 1, 'CheckBox', NULL, 0, NULL, NULL, 1, '^D=Filter needle used with administration')
			,('IVMedication', 83, 'This is considered a thrombolytic infusion (See Thrombolytic Record)', 1, 'CheckBox', NULL, 0, NULL, NULL, 1, '^D=This is considered a thrombolytic infusion (See Thrombolytic Record)')
			,('IVMedication', 84, 'This is considered a sedation medication (See Sedation Record)', 1, 'CheckBox', NULL, 0, NULL, NULL, 1, '^D=This is considered a procedural sedation medication (See Sedation Record)')
			...
			,('IntraMuscMedication', 5, 'Amount given ~~(non-antibiotic/immunization)', 1, 'FreeText', NULL, 1, NULL, NULL, 1, '^CAmount given:^^^^medsvc_amtgiven=')
			...
			,('IntraMuscMedication', 10, 'Amount given ~~(antibiotic)', 1, 'FreeText', NULL, 1, NULL, NULL, 1, '^CAmount given:=')
			...
			,('IntraMuscMedication', 15, 'Amount given ~~(immunization)', 1, 'FreeText', NULL, 1, NULL, NULL, 1, '^CAmount given:^^^^medsvc_vac_amt=')
			...
			,('VitalSigns', 3, ' ~~(bpCondition)', 1, 'PreMedication', NULL, 0, NULL, NULL, 1, '')
			-- ,('VitalSigns', 4, ' ~~(bpSite)', 0, 'DropDownListBox', NULL, 0, NULL, NULL, 1, '')
			,('VitalSigns', 5, 'MAP', 1, 'FreeText', NULL, 0, NULL, NULL, 1, '^CMap:=')
			-- ,('VitalSigns', 6, ' ~~(mapSelect1)', 0, 'DropDownListBox', NULL, 0, NULL, NULL, 1, '')
			-- ,('VitalSigns', 7, ' ~~(mapSelect2)', 0, 'DropDownListBox', NULL, 0, NULL, NULL, 1, '')
			,('VitalSigns', 8, 'PULSE', 1, 'FreeText', NULL, 0, NULL, NULL, 1, '^CPulse:=')
			,('VitalSigns', 9, ' ~~(pulseSelect1)', 1, 'DropDownListBox', NULL, 0, NULL, NULL, 1, '')
			-- ,('VitalSigns', 10, ' ~~(pulseSelect2)', 0, 'DropDownListBox', NULL, 0, NULL, NULL, 1, '')
			...
			-- ,('VitalSigns', 13, ' ~~(temperatureSelect2)', 0, 'DropDownListBox', NULL, 0, NULL, NULL, 1, '')
			,('VitalSigns', 14, 'O2 SAT', 1, 'FreeText', NULL, 0, NULL, NULL, 1, '^CO2 Sat:=')
			,('VitalSigns', 15, ' ~~(O2SatSelect1)', 1, 'DropDownListBox', NULL, 0, NULL, NULL, 1, '')
			,('VitalSigns', 16, ' ~~(O2SatSelect2)', 1, 'DropDownListBox', NULL, 0, NULL, NULL, 1, '')
			,('VitalSigns', 17, 'RESPIRATORY', 1, 'FreeText', NULL, 0, NULL, NULL, 1, '^CRespiratory:=')
			-- ,('VitalSigns', 18, ' ~~(respiratorySelect1)', 0, 'DropDownListBox', NULL, 0, NULL, NULL, 1, '')
			-- ,('VitalSigns', 19, ' ~~(respiratorySelect2)', 0, 'DropDownListBox', NULL, 0, NULL, NULL, 1, '')
			,('VitalSigns', 20, 'PAIN', 1, 'FreeText', NULL, 0, NULL, NULL, 1, '^CPain:=')
			-- ,('VitalSigns', 21, ' ~~(painSelect1)', 0, 'DropDownListBox', NULL, 0, NULL, NULL, 1, '')
			-- ,('VitalSigns', 22, ' ~~(painSelect2)', 0, 'DropDownListBox', NULL, 0, NULL, NULL, 1, '')
			,('VitalSigns', 23, 'END-TIDAL CO2', 1, 'FreeText', NULL, 0, NULL, NULL, 1, '^CEnd-Tidal CO2:=')
			-- ,('VitalSigns', 24, ' ~~(end-tidalCo2Select1)', 0, 'DropDownListBox', NULL, 0, NULL, NULL, 1, '')
			-- ,('VitalSigns', 25, ' ~~(end-tidalCo2Select2)', 0, 'DropDownListBox', NULL, 0, NULL, NULL, 1, '')
			...
			,('PreMedication', 1, 'Pain Level', 1, 'DropDownListBox', NULL, 1, NULL, NULL, 1, '')
...
from   (values
			...
			-- BP Attribute 1 is ACTIVE;  Attibute 2 is INACTIVE
			,('VitalSigns', ' ~~(bpCondition)', 1, 'R arm lying', '^S=BP taken right arm lying')
			,('VitalSigns', ' ~~(bpCondition)', 2, 'L arm lying', '^S=BP taken left arm lying')
			,('VitalSigns', ' ~~(bpCondition)', 3, 'R arm sitting', '^S=BP taken right arm sitting')
			,('VitalSigns', ' ~~(bpCondition)', 4, 'L arm sitting', '^S=BP taken left arm sitting')
			,('VitalSigns', ' ~~(bpCondition)', 5, 'R arm standing', '^S=BP taken right arm standing')
			,('VitalSigns', ' ~~(bpCondition)', 6, 'L arm standing', '^S=BP taken left arm standing')
			,('VitalSigns', ' ~~(bpCondition)', 7, 'R leg lying', '^S=BP taken right leg lying')
			,('VitalSigns', ' ~~(bpCondition)', 8, 'R leg lying', '^S=BP taken left leg lying')
			-- ,('VitalSigns', ' ~~(bpSite)', 1, 'Left Arm', '^S=BP taken on left arm')
			-- ,('VitalSigns', ' ~~(bpSite)', 2, 'Right Arm', '^S=BP taken on right arm')

			-- Pulse Attribute 1 is ACTIVE;  Attibute 2 is INACTIVE
			,('VitalSigns', ' ~~(pulseSelect1)', 1, 'apical', '^S=Apical Pulse taken')
			,('VitalSigns', ' ~~(pulseSelect1)', 2, 'capillary', '^S=Capillary Pulse taken')
			,('VitalSigns', ' ~~(pulseSelect1)', 3, 'radial', '^S=Radial Pulse taken')
			,('VitalSigns', ' ~~(pulseSelect1)', 4, 'brachial', '^S=Brachial Pulse taken')
			,('VitalSigns', ' ~~(pulseSelect1)', 5, 'pedal', '^S=Pedal Pulse taken')
			,('VitalSigns', ' ~~(pulseSelect1)', 6, 'carotid', '^S=Carotid Pulse taken')
			,('VitalSigns', ' ~~(pulseSelect1)', 7, 'femoral', '^S=Femoral Pulse taken')
			...
			-- Temperature  Attribute 1 is ACTIVE;  Attibute 2 is INACTIVE	
			,('VitalSigns', ' ~~(temperatureSelect1)', 1, 'oral', '^S= Oral Temperature taken')
			,('VitalSigns', ' ~~(temperatureSelect1)', 2, 'temporal', '^S=Tmeporal Temperature taken')
			,('VitalSigns', ' ~~(temperatureSelect1)', 3, 'axillary', '^S=Axillary Temperature taken')
			,('VitalSigns', ' ~~(temperatureSelect1)', 4, 'tympanic', '^S=Tympanic Temperature taken')
			,('VitalSigns', ' ~~(temperatureSelect1)', 5, 'rectal', '^S=Recatal Temperature taken')
			,('VitalSigns', ' ~~(temperatureSelect1)', 6, 'foley', '^S=Foley Temperature taken')
			...
			-- Both Map attributes are INACTIVE
			...
			-- Both O2 Sat attributes are ACTIVE 
			,('VitalSigns', ' ~~(O2SatSelect1)', 1, '% on room air', '^S=% on room air')
			,('VitalSigns', ' ~~(O2SatSelect1)', 2, '% on nasal cannula', '^S=% on nasal cannula')
			,('VitalSigns', ' ~~(O2SatSelect1)', 3, '% on simple mask', '^S=% on simple mask')
			,('VitalSigns', ' ~~(O2SatSelect1)', 4, '% on venti mask', '^S=% on venti mask')
			,('VitalSigns', ' ~~(O2SatSelect1)', 5, '% on non-rebreather', '^S=% on non-rebreather')
			,('VitalSigns', ' ~~(O2SatSelect1)', 6, '% on heated high flow nasal cannula', '^S=% on heated high flow nasal cannula')
			,('VitalSigns', ' ~~(O2SatSelect1)', 7, '% on CPAP', '^S=% on CPAP')
			,('VitalSigns', ' ~~(O2SatSelect1)', 8, '% on BiPAP', '^S=% on BiPAP')
			,('VitalSigns', ' ~~(O2SatSelect1)', 9, '% on blowby', '^S=% on blowby')
			,('VitalSigns', ' ~~(O2SatSelect1)', 10, '% on mechanical vent', '^S=% on mechanical vent')
			,('VitalSigns', ' ~~(O2SatSelect1)', 11, '% on trach collar', '^S=% on trach collar')
			,('VitalSigns', ' ~~(O2SatSelect1)', 12, '% on Ambu bag', '^S=% on Ambu bag')
			,('VitalSigns', ' ~~(O2SatSelect1)', 13, '% on ETT', '^S=% on ETT')
			,('VitalSigns', ' ~~(O2SatSelect2)', 1, '0.25 LPM', '^S=0.25 LPM')
			,('VitalSigns', ' ~~(O2SatSelect2)', 2, '0.5 LPM', '^S=0.5 LPM')
			,('VitalSigns', ' ~~(O2SatSelect2)', 3, '1 LPM', '^S=1 LPM')
			,('VitalSigns', ' ~~(O2SatSelect2)', 4, '2 LPM', '^S=2 LPM')
			,('VitalSigns', ' ~~(O2SatSelect2)', 5, '3 LPM', '^S=3 LPM')
			,('VitalSigns', ' ~~(O2SatSelect2)', 6, '4 LPM', '^S=4 LPM')
			,('VitalSigns', ' ~~(O2SatSelect2)', 7, '5 LPM', '^S=5 LPM')
			,('VitalSigns', ' ~~(O2SatSelect2)', 8, '6 LPM', '^S=6 LPM')
			,('VitalSigns', ' ~~(O2SatSelect2)', 9, '7 LPM', '^S=7 LPM')
			,('VitalSigns', ' ~~(O2SatSelect2)', 10, '8 LPM', '^S=8 LPM')
			,('VitalSigns', ' ~~(O2SatSelect2)', 11, '9 LPM', '^S=9 LPM')
			,('VitalSigns', ' ~~(O2SatSelect2)', 12, '10 LPM', '^S=10 LPM')
			,('VitalSigns', ' ~~(O2SatSelect2)', 13, '11 LPM', '^S=11 LPM')
			,('VitalSigns', ' ~~(O2SatSelect2)', 14, '12 LPM', '^S=12 LPM')
			,('VitalSigns', ' ~~(O2SatSelect2)', 15, '13 LPM', '^S=13 LPM')
			,('VitalSigns', ' ~~(O2SatSelect2)', 16, '14 LPM', '^S=14 LPM')
			,('VitalSigns', ' ~~(O2SatSelect2)', 17, '15 LPM', '^S=15 LPM')
			,('VitalSigns', ' ~~(O2SatSelect2)', 18, '16 LPM', '^S=16 LPM')
			,('VitalSigns', ' ~~(O2SatSelect2)', 19, '17 LPM', '^S=17 LPM')
			,('VitalSigns', ' ~~(O2SatSelect2)', 20, '18 LPM', '^S=18 LPM')
			,('VitalSigns', ' ~~(O2SatSelect2)', 21, '19 LPM', '^S=19 LPM')
			,('VitalSigns', ' ~~(O2SatSelect2)', 22, '20 LPM', '^S=20 LPM')
			,('VitalSigns', ' ~~(O2SatSelect2)', 23, '21 LPM', '^S=21 LPM')
			,('VitalSigns', ' ~~(O2SatSelect2)', 24, '22 LPM', '^S=22 LPM')
			,('VitalSigns', ' ~~(O2SatSelect2)', 25, '23 LPM', '^S=23 LPM')
			,('VitalSigns', ' ~~(O2SatSelect2)', 26, '24 LPM', '^S=24 LPM')
			,('VitalSigns', ' ~~(O2SatSelect2)', 27, '25 LPM', '^S=25 LPM')
			,('VitalSigns', ' ~~(O2SatSelect2)', 28, '26 LPM', '^S=26 LPM')
			,('VitalSigns', ' ~~(O2SatSelect2)', 29, '27 LPM', '^S=27 LPM')
			,('VitalSigns', ' ~~(O2SatSelect2)', 30, '28 LPM', '^S=28 LPM')
			,('VitalSigns', ' ~~(O2SatSelect2)', 31, '29 LPM', '^S=29 LPM')
			,('VitalSigns', ' ~~(O2SatSelect2)', 32, '30 LPM', '^S=30 LPM')
			,('VitalSigns', ' ~~(O2SatSelect2)', 33, '31 LPM', '^S=31 LPM')
			,('VitalSigns', ' ~~(O2SatSelect2)', 34, '32 LPM', '^S=32 LPM')
			,('VitalSigns', ' ~~(O2SatSelect2)', 35, '33 LPM', '^S=33 LPM')
			,('VitalSigns', ' ~~(O2SatSelect2)', 36, '34 LPM', '^S=34 LPM')
			,('VitalSigns', ' ~~(O2SatSelect2)', 37, '35 LPM', '^S=35 LPM')
			,('VitalSigns', ' ~~(O2SatSelect2)', 38, '36 LPM', '^S=36 LPM')
			,('VitalSigns', ' ~~(O2SatSelect2)', 39, '37 LPM', '^S=37 LPM')
			,('VitalSigns', ' ~~(O2SatSelect2)', 40, '38 LPM', '^S=38 LPM')
			,('VitalSigns', ' ~~(O2SatSelect2)', 41, '39 LPM', '^S=39 LPM')
			,('VitalSigns', ' ~~(O2SatSelect2)', 42, '40 LPM', '^S=40 LPM')

			-- Both Respiratory attributes are INACTIVE 
			...
			-- Both Pain attributes are INACTIVE 
			...
			-- Both End Tidal attributes are INACTIVE 
		...
		-- IV  template ------------------------------------------------
			...
			,('PreMedication', 'Pain Level', 1, '1', '^S^=Pre Med Pain Level: 1')
			,('PreMedication', 'Pain Level', 2, '2', '^S^=Pre Med Pain Level: 2')
			,('PreMedication', 'Pain Level', 3, '3', '^S^=Pre Med Pain Level: 3')
			,('PreMedication', 'Pain Level', 4, '4', '^S^=Pre Med Pain Level: 4')
			,('PreMedication', 'Pain Level', 5, '5', '^S^=Pre Med Pain Level: 5')
			,('PreMedication', 'Pain Level', 6, '6', '^S^=Pre Med Pain Level: 6')
			,('PreMedication', 'Pain Level', 7, '7', '^S^=Pre Med Pain Level: 7')
			,('PreMedication', 'Pain Level', 8, '8', '^S^=Pre Med Pain Level: 8')
			,('PreMedication', 'Pain Level', 9, '9', '^S^=Pre Med Pain Level: 9')
			,('PreMedication', 'Pain Level', 10, '10', '^S^=Pre Med Pain Level: 10')
