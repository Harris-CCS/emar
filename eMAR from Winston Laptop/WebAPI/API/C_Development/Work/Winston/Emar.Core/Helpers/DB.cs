...
namespace Emar.Core.Helpers
{
    ...
    public class DB : IDBUtility
    {
        ...
        /// <summary>
        /// Take a byte array and return either the byte array (if not null) or the necessary DBNull.Value for a SqlParameter value
        /// </summary>
        /// <param name="p">byte[] value</param>
        /// <returns>Object suitable for user in SqlParameter() { Value = obj }</returns>
        public static object NullParam(byte[] p)
        {
