...
from   (values
			...
			,('IntraDermMedication', 6, 'Other site', 1, 'FreeText', NULL, 0, NULL, NULL, 1, '^CMedication administered to ^IV_Location=')
			...
			,('IntraOssMedication', 6, 'Other Site', 1, 'FreeText', NULL, 0, NULL, NULL, 1, '^CMedication administered to ^IV_Location=')
			...
			,('SubcutanMedication', 6, 'Other site', 1, 'FreeText', NULL, 0, NULL, NULL, 1, '^CMedication administered to ^IV_Location=')
			...
			,('IVInIMedication', 3, 'Amount given', 1, 'FreeText', NULL, 1, NULL, NULL, 1, '^CAmount given:=')
			...
			,('IVMedication', 2, 'Amount given', 1, 'FreeText', NULL, 1, NULL, NULL, 1, '^CAmount given:=')
			...
			,('IntraMuscMedication', 9, 'Other site ~~(antibiotic)', 1, 'DropDownListBox', NULL, 0, NULL, NULL, 1, '^CMedication administered to ^IV_Location2=')
			...
			,('IntraMuscMedication', 14, 'Other site ~~(immunization)', 1, 'DropDownListBox', NULL, 0, NULL, NULL, 1, '^CMedication administered to ^IV_Location^^^medsvc_vac_site=')
			...
			,('StopTime', 3, 'Stop time unknown', 1, 'CheckBox', NULL, 0, NULL, NULL, 1, '^D^CORE_unknown_stoptime=Unknown stop time^^U')
			,('StopTime', 4, 'Continued upon Transfer', 1, 'CheckBox', NULL, 0, NULL, 'true', 1, '^D=Infusion continued upon transfer from emergency department^^U')
			,('StopTime', 5, 'Date/Time ~~(infusionContinuedUponTransfer)', 1, 'DateTime', '', 0, NULL, NULL, 1,'^Con=')
...
from   (values
			...
			,('IntraMuscMedication', 'Site ~~(non-antibiotic/immunization)', 1, 'Deltiod, Left', '^S^IV_Location=Medication administered to left deltoid^^left deltoid')
			,('IntraMuscMedication', 'Site ~~(non-antibiotic/immunization)', 2, 'Deltiod, Right', '^S^IV_Location=Medication administered to right deltoid^^right deltoid')
			,('IntraMuscMedication', 'Site ~~(non-antibiotic/immunization)', 3, 'Buttock, Left', '^S^IV_Location=Medication administered to left buttock^^left buttock')
			,('IntraMuscMedication', 'Site ~~(non-antibiotic/immunization)', 4, 'Buttock, Right', '^S^IV_Location=Medication administered to right buttock^^right buttock')
			,('IntraMuscMedication', 'Site ~~(non-antibiotic/immunization)', 5, 'Hip, Left', '^S^IV_Location=Medication administered to left hip^^left hip')
			,('IntraMuscMedication', 'Site ~~(non-antibiotic/immunization)', 6, 'Hip, Right', '^S^IV_Location=Medication administered to right hip^^right hip')
			,('IntraMuscMedication', 'Site ~~(non-antibiotic/immunization)', 7, 'Thigh, Left', '^S^IV_Location=Medication administered to left thigh^^left thigh')
			,('IntraMuscMedication', 'Site ~~(non-antibiotic/immunization)', 8, 'Thigh, Right', '^S^IV_Location=Medication administered to right thigh^^right thigh')
			,('IntraMuscMedication', 'Site ~~(non-antibiotic/immunization)', 9, 'Other IV sites', '^S^IV_Location=Other IV Site')

			,('IntraMuscMedication', 'Site ~~(antibiotic)', 1, 'Deltiod, Left', '^S^IV_Location=Medication administered to left deltoid^^left deltoid')
			,('IntraMuscMedication', 'Site ~~(antibiotic)', 2, 'Deltiod, Right', '^S^IV_Location=Medication administered to right deltoid^^right deltoid')
			,('IntraMuscMedication', 'Site ~~(antibiotic)', 3, 'Buttock, Left', '^S^IV_Location=Medication administered to left buttock^^left buttock')
			,('IntraMuscMedication', 'Site ~~(antibiotic)', 4, 'Buttock, Right', '^S^IV_Location=Medication administered to right buttock^^right buttock')
			,('IntraMuscMedication', 'Site ~~(antibiotic)', 5, 'Hip, Left', '^S^IV_Location=Medication administered to left hip^^left hip')
			,('IntraMuscMedication', 'Site ~~(antibiotic)', 6, 'Hip, Right', '^S^IV_Location=Medication administered to right hip^^right hip')
			,('IntraMuscMedication', 'Site ~~(antibiotic)', 7, 'Thigh, Left', '^S^IV_Location=Medication administered to left thigh^^left thigh')
			,('IntraMuscMedication', 'Site ~~(antibiotic)', 8, 'Thigh, Right', '^S^IV_Location=Medication administered to right thigh^^right thigh')
			,('IntraMuscMedication', 'Site ~~(antibiotic)', 9, 'Other IV sites', '^S^IV_Location=Other IV Site')

			,('IntraMuscMedication', 'Site ~~(immunization)', 1, 'Deltiod, Left', '^S^IV_Location=Medication administered to left deltoid^^left deltoid')
			,('IntraMuscMedication', 'Site ~~(immunization)', 2, 'Deltiod, Right', '^S^IV_Location=Medication administered to right deltoid^^right deltoid')
			,('IntraMuscMedication', 'Site ~~(immunization)', 3, 'Buttock, Left', '^S^IV_Location=Medication administered to left buttock^^left buttock')
			,('IntraMuscMedication', 'Site ~~(immunization)', 4, 'Buttock, Right', '^S^IV_Location=Medication administered to right buttock^^right buttock')
			,('IntraMuscMedication', 'Site ~~(immunization)', 5, 'Hip, Left', '^S^IV_Location=Medication administered to left hip^^left hip')
			,('IntraMuscMedication', 'Site ~~(immunization)', 6, 'Hip, Right', '^S^IV_Location=Medication administered to right hip^^right hip')
			,('IntraMuscMedication', 'Site ~~(immunization)', 7, 'Thigh, Left', '^S^IV_Location=Medication administered to left thigh^^left thigh')
			,('IntraMuscMedication', 'Site ~~(immunization)', 8, 'Thigh, Right', '^S^IV_Location=Medication administered to right thigh^^right thigh')
			,('IntraMuscMedication', 'Site ~~(immunization)', 9, 'Other IV sites', '^S^IV_Location=Other IV Site')

			,('IntraDermMedication', 'Site', 1, 'Chest, Left', '^S^IV_Location=Medication administered to left chest^QX1676^left chest')
			,('IntraDermMedication', 'Site', 2, 'Chest, Right', '^S^IV_Location=Medication administered to right chest^QX1676^right chest')
			,('IntraDermMedication', 'Site', 3, 'Forearm, Left', '^S^IV_Location=Medication administered to left forearm^QX1676^left forearm')
			,('IntraDermMedication', 'Site', 4, 'Forearm, Right', '^S^IV_Location=Medication administered to right forearm^QX1676^right forearm')
			,('IntraDermMedication', 'Site', 5, 'Back, Left upper', '^S^IV_Location=Medication administered to left upper back^QX1676^left upper back')
			,('IntraDermMedication', 'Site', 6, 'Back, Right upper', '^S^IV_Location=Medication administered to right upper back^QX1676^rigth upper back')
			,('IntraDermMedication', 'Site', 7, 'Abdomen, Left', '^S^IV_Location=Medication administered to left abdomen^QX1676^left abdomen')
			,('IntraDermMedication', 'Site', 8, 'Abdomen, Right', '^S^IV_Location=Medication administered to right abdomen^QX1676^right abdomen')
			,('IntraDermMedication', 'Site', 9, 'Other IV sites', '^S^IV_Location=Other IV Site')

			,('IntraOssMedication', 'Site', 1, 'Tibia, Left proximal', '^S^IV_Location=Medication administered to left proximal tibia^QX4747^left proximal tibia')
			,('IntraOssMedication', 'Site', 2, 'Tibia, Right proximal', '^S^IV_Location=Medication administered to right proximal tibia^QX4747^right proximal tibia')
			,('IntraOssMedication', 'Site', 3, 'Tibia, Left distal', '^S^IV_Location=Medication administered to left distal tibia^QX4747^left distal tibia')
			,('IntraOssMedication', 'Site', 4, 'Tibia, Right distal', '^S^IV_Location=Medication administered to right distal tibia^QX4747^right distal tibia')
			,('IntraOssMedication', 'Site', 5, 'Femur, Left', '^S^IV_Location=Medication administered to left femur^QX4747^left femur')
			,('IntraOssMedication', 'Site', 6, 'Femur, Right', '^S^IV_Location=Medication administered to right femur^QX4747^right femur')
			...
			,('SubcutanMedication', 'Medication site', 1, 'Arm, Left upper', '^S^IV_Location=Medication administered to left upper arm^QX216^left upper arm')
			,('SubcutanMedication', 'Medication site', 2, 'Arm, Right upper', '^S^IV_Location=Medication administered to right upper arm^QX216^right upper arm')
			,('SubcutanMedication', 'Medication site', 3, 'Back, Left upper', '^S^IV_Location=Medication administered to left upper back^QX216^left upper back')
			,('SubcutanMedication', 'Medication site', 4, 'Back, Right upper', '^S^IV_Location=Medication administered to right upper back^QX216^right upper back')
			,('SubcutanMedication', 'Medication site', 5, 'Back, Left lower', '^S^IV_Location=Medication administered to left lower back^QX216^left lower back')
			,('SubcutanMedication', 'Medication site', 6, 'Back, Right lower', '^S^IV_Location=Medication administered to right lower back^QX216^right lower back')
			,('SubcutanMedication', 'Medication site', 7, 'Abdomen, Left', '^S^IV_Location=Medication administered to left abdomen^QX216^left abdomen')
			,('SubcutanMedication', 'Medication site', 8, 'Abdomen, Right', '^S^IV_Location=Medication administered to right abdomen^QX216^right abdomen')
			,('SubcutanMedication', 'Medication site', 9, 'Thigh, Left', '^S^IV_Location=Medication administered to left thigh^QX216^left thigh')
			,('SubcutanMedication', 'Medication site', 10, 'Thigh, Right', '^S^IV_Location=Medication administered to right thigh^QX216^right thigh')
			,('SubcutanMedication', 'Medication site', 11, 'Other IV sites', '^S^IV_Location=IV Site')

			,('SubcutanMedication', 'Immunization site', 1, 'Arm, Left upper', '^S^IV_Location=Immunization administered to left upper arm^^left upper arm^medsvc_vac_site')
			,('SubcutanMedication', 'Immunization site', 2, 'Arm, Right upper', '^S^IV_Location=Immunization administered to right upper arm^^right upper arm^medsvc_vac_site')
			,('SubcutanMedication', 'Immunization site', 3, 'Back, Left upper', '^S^IV_Location=Immunization administered to left upper back^^left upper back^medsvc_vac_site')
			,('SubcutanMedication', 'Immunization site', 4, 'Back, Right upper', '^S^IV_Location=Immunization administered to right upper back^^right upper back^medsvc_vac_site')
			,('SubcutanMedication', 'Immunization site', 5, 'Back, Left lower', '^S^IV_Location=Immunization administered to left lower back^^left lower back^medsvc_vac_site')
			,('SubcutanMedication', 'Immunization site', 6, 'Back, Right lower', '^S^IV_Location=Immunization administered to right lower back^^right lower back^medsvc_vac_site')
			,('SubcutanMedication', 'Immunization site', 7, 'Abdomen, Left', '^S^IV_Location=Immunization administered to left abdomen^^left abdomen^medsvc_vac_site')
			,('SubcutanMedication', 'Immunization site', 8, 'Abdomen, Right', '^S^IV_Location=Immunization administered to right abdomen^^right abdomen^medsvc_vac_site')
			,('SubcutanMedication', 'Immunization site', 9, 'Thigh, Left', '^S^IV_Location=Immunization administered to left thigh^^left thigh^medsvc_vac_site')
			,('SubcutanMedication', 'Immunization site', 10, 'Thigh, Right', '^S^IV_Location=Immunization administered to right thigh^^right thigh^medsvc_vac_site')
