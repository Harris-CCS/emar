...
namespace Emar.Data.Entities
{
    ...
    public class PatientOrder
    {
        public PatientOrder()
        {
            ...
            FutureAdministrationsReschedules = new HashSet<FutureAdministrationsReschedule>();
        }
        ...
        //Whether or not the medication for this order is in
        //the medications_high_risk table.
        //Winston Murdock, 11/10/2021.  PC-26733
        [NotMapped]
        public bool IsHighRisk { get; set; }
        
        //Whether or not the patient for this order is pediatric.
        //Currently, this is hardcoded as 12 or younger.
        //In the future, we should make this a site setting.
        //Winston Murdock, 11/11/2021.  PC-26733
        [NotMapped]
        public bool IsPedatric { get; set; }
        ...
        //for foreign key fk__future_administration_reschedule__patient_orders
        [InverseProperty("PatientOrder")]
        public virtual ICollection<FutureAdministrationsReschedule> FutureAdministrationsReschedules { get; set; }
    }
}