...
namespace Emar.Data.IbexEntities
{
    ...
    public class MedicationDetails
    {
        ...
        [Column("entered_dose", TypeName = "varchar(40)")] public string EnteredDose { get; set; }

        [Column("entered_unit", TypeName = "varchar(20)")] public string EnteredUnit { get; set; }
        ...
        [Column("drug_form_id", TypeName = "varchar(32)")] public string DrugFormId { get; set; }

        [Column("rxcui", TypeName = "int")] public int? RxCUI { get; set; }
