...
namespace Emar.Core.Users.Service
{
    public interface IUserService
    {
        ...
        OrderingPhysicianDataDto GetOrderingPhysicians(int siteId, long patientId, int userId);

        string GetUserDefaultMarFilters(int userId);

        string SetUserDefaultFilters(int userId, PatientsResourceParameters resourceParameters);
    }
}