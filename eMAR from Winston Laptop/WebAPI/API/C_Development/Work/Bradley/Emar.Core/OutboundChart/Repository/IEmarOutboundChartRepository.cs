...
//        Task<EMR.Line> ChartEntry(IPatient patient, Medication med, string sysDate, List<OverrideRationale> overrides);
        ...
        bool GetPharmVerificationReqStatus(long patientId);
        byte GetPharmVerificationStatus(long orderId);
        ...
        List<EMR.Line> ChartVitalsEntries(int userId, string losecs, string enteredTime, OcsVitals vitals, DateTimeOffset siteNow);
    }
}
