...
namespace Emar.Core.Medications.Repository
{
    public interface IInteractionRepository
    {
        ...
        bool RecordNewInteractionsReactions(IEnumerable<MedicationInteractionReaction> interactionsReactions, long orderId, EmarOrderType orderType, bool insertOnly = true, bool? deleteExisting = false);
    }
}