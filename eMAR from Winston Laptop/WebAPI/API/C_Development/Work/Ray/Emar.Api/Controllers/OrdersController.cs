...
namespace Emar.Api.Controllers
{
    ...
    public class OrdersController : ControllerBase
    {
            ...
            [FromRoute(Name = "actionId")] int actionId)
        {
            ...
            {
                return Problem(Emar.Core.Helpers.Utilities.ExtractExceptionMessages(e), statusCode: (int)HttpStatusCode.InternalServerError);
            }
...
)
        {
            ...
            {
                return Problem(Emar.Core.Helpers.Utilities.ExtractExceptionMessages(e),
