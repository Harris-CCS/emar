...
namespace Emar.Api.Controllers
{
    ...
    public class MedicationsController : Controller
    {
        ...
        /// <summary>
        /// Get the list of PRN indications.
        /// </summary>
        /// <param name="mediaType">
        /// Media type from Accept header.
        /// </param>
        /// <param name="siteId">
        /// The ID of the site the user is logged in to.
        /// </param>
        /// <returns>The list of PRN Indications</returns>
        /// <remarks>
        /// </remarks>
        [HttpGet("api/PrnIndications/site/{siteId}", Name = nameof(GetPrnIndicationsBySiteId))]
        [ProducesResponseType(200)] // (OK) - the resource is sent in the response
        [ProducesResponseType(400)] // (bad request) - indicates a bad request (e.g. wrong parameter)
        [ProducesResponseType(404)] // (not found) - the resource does not exits
        public ActionResult<IEnumerable<DoseRangeCheckingInfoDto>> GetPrnIndicationsBySiteId
        (
            [FromHeader(Name = "Accept")] string mediaType,
            [FromRoute(Name = "siteId")] int siteId
        )
        {
            ...
            var prnIndications = _medicationService.GetPrnIndicationsBySiteId(siteId);

            return Ok(prnIndications);
        } //end GetDoseRangeCheckingInfo
