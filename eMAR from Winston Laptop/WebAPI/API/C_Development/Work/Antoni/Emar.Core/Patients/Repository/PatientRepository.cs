...
namespace Emar.Core.Patients.Repository
{
    public class PatientRepository : IPatientRepository
    {
        ...
        public void FilePatient(Patient patientFromHost, string externalPatientId)
        {
            if (patientFromHost.Id > 0)
            {
                // TODO: Test this code
                Patient existingPatient = _context.Patients.FirstOrDefault(u => u.Id == patientFromHost.Id);
                UpdatePatientValues(existingPatient, patientFromHost);
        ...
        private static void UpdatePatientValues(Patient existingUser, Patient userFromHost)
        {
            existingUser.SiteId = userFromHost.SiteId;
            throw new NotImplementedException("PatientRepository.UpdatePatientValues()");
