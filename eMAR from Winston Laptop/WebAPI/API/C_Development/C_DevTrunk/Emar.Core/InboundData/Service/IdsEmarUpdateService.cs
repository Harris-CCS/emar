...
namespace Emar.Core.InboundData.Service
{
    public class IdsEmarUpdateService : IIdsEmarUpdateService
    {
        ...
        public void FilePatient(Patient patient, out bool interactRecalcNeeded, string queueRecordId)
        {
            SetInternalPatientId(patient);
            _patientRepository.FilePatient(patient, out interactRecalcNeeded, queueRecordId);
        }
