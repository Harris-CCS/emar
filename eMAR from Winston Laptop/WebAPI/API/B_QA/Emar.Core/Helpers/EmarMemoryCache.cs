...
namespace Emar.Core.Helpers
{
    ...
    public static class CacheKeys
    {
        ...
        public static string CodeShares => "_CodeShares";

        public static string CodeSharesList => "_CodeSharesList";
        public static object MedicationRoutes => "_MedicationRoutes";
        public static object MedicationUnits => "_MedicationUnits";
        public static string PrnIndications => "PrnIndications";
    }
}