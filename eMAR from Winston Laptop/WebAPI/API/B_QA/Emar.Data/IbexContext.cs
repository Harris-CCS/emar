...
namespace Emar.Data
{
    public class IbexContext : DbContext
    {
        ...
        public virtual DbSet<EmarPatientAllergiesRetrieveFn> EmarPatientAllergiesRetrieveFns { get; set; }
        public virtual DbSet<EmarPatientMedicationsRetrieveFn> EmarPatientMedicationsRetrieveFns { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<EmarPatientAllergiesRetrieveFn>(entity =>
            {
                entity.HasNoKey();
            ...
            modelBuilder.Entity<EmarPatientMedicationsRetrieveFn>(entity =>
            {
                entity.HasNoKey();
                ...
                entity.Property(e => e.MedicationDrugId).IsUnicode(false);
                ...
                entity.Property(e => e.LastTakenNote).IsUnicode(false);
            });
