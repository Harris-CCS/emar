...
namespace Emar.Data.Entities
{
    ...
    public class Patient
    {
        public Patient()
        {
            ...
            //fk__print_history__patients
            PrintHistorys = new HashSet<PrintHistory>();

            // For Foreign Key: fk__user_patients__patients
            UserPatients = new HashSet<UserPatient>();

            //For Foreign Key: fk__pharmacy_notifications__patients
            PharmacyNotifications = new HashSet<PharmacyNotification>();
        }
        ...
        [NotMapped]
        public ExternalIdEntity ExternalId { get; set; }

        /// <summary>
        /// The following two properties are provided so that we don't have to go through a generic object
        /// </summary>
        [NotMapped]
