...
namespace Emar.Data.Entities
{
    ...
    public class Medication
    {
        public Medication()
        {
            AntimicrobialRequiredIndicators = new HashSet<AntimicrobialRequiredIndicator>();
            ...
            MedicationsHighRisks = new HashSet<MedicationsHighRisk>();
        ...
        //The rows in fdb_ndc_info for this medication.
        [NotMapped]
        public List<FdbNdcInfo>? FdbNdcInfos { get; set; }
        ...
        [InverseProperty(nameof(Entities.FdbBrandName.Medications))]
        public virtual FdbBrandName FdbBrandName { get; set; }

        [InverseProperty("Medication")]
        public virtual ICollection<AntimicrobialRequiredIndicator> AntimicrobialRequiredIndicators { get; set; }
        ...
        [InverseProperty("Medication")]
        public virtual ICollection<MedicationsHighRisk> MedicationsHighRisks{ get; set; }
    }
}
