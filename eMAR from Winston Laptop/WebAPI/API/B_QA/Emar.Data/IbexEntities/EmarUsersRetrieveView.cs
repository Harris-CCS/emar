...
namespace Emar.Data.IbexEntities
{
    ...
    public class EmarUsersRetrieveView  
    {
        ...
        //Adding medprn (which is the last used device in ibex/PCED).
        //On 57c, it is null, -negative, 0, or a device id.
        //I added a case statement to the view and convert null and negative values to 0.
        //That way I know will never be null and will always be an integer.
        //Winston Murdock, 07/14/2021.  EMAR-1087.
        [Column("medprn", TypeName = "int")]
        public int MedPrn { get; set; }
    }
}