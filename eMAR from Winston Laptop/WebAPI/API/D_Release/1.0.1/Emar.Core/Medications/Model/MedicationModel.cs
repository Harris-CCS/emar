...
namespace Emar.Core.Medications.Model
{
    public class MedicationInteractionReaction
    {
        ...
        public List<Dictionary<string, object>> Interactions { get; set; } = new List<Dictionary<string, object>>();
        public List<Dictionary<string, object>> Reactions { get; set; } = new List<Dictionary<string, object>>();
    }
    ...
    public class MedicationModel
    {
        ...
        public string SourceTable { get; set; }
        public long? SourceTableId { get; set; }
        public int? SourceTableMedicationId { get; set; }
        public MedicationDto SourceTableMedication { get; set; }
        public EmarOrderType Type { get; set; }
