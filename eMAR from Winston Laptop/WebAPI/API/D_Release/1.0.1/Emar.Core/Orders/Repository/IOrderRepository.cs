...
namespace Emar.Core.Orders.Repository
{
    public interface IOrderRepository
    {
        ...
        IEnumerable<Medication> GetSchedulerSetupData(int siteId, string brandName);
        ...
        List<FrequencyScheduleAdministration> GetSchedulerAdministrations(int siteId, EmarOrderType itemType, int itemId, DateTimeOffset start, DateTimeOffset? stop);
        ...
        List<FrequencyScheduleAdministration> GetNewAdministrations(int siteId, int frequencyId, DateTimeOffset start, DateTimeOffset? stop);
    }
}