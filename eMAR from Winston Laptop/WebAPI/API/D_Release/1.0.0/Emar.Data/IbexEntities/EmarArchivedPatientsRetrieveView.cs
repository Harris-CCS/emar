...
{
    [Table("emar_archived_patients_retrieve_view")]
    public class EmarArchivedPatientsRetrieveView
    {
        [Key]
        ...
        [Column("room_bed_code", TypeName = "varchar(30)")]
        ...
        [Column("urgency_color", TypeName = "varchar(30)")]
        public string UrgencyColor { get; set; }

        [Column("name_alert", TypeName = "int"), Required]
        public int NameAlert { get; set; }

        [Column("withdraw_consent", TypeName = "int")]
        public int WithdrawConsent { get; set; }

        [Column("vs_datetime", TypeName = "varchar(1)"), Required]
        public string VsDatetime { get; set; }

        [Column("vs_blood_pressure_indicator", TypeName = "varchar(1)"), Required]
        public string VsBloodPressureIndicator { get; set; }

        [Column("vs_systolic", TypeName = "varchar(1)"), Required]
        public string VsSystolic { get; set; }

        [Column("vs_diastolic", TypeName = "varchar(1)"), Required]
        public string VsDiastolic { get; set; }

        [Column("vs_pulse_indicator", TypeName = "varchar(1)"), Required]
        public string VsPulseIndicator { get; set; }

        [Column("vs_pulse", TypeName = "varchar(1)"), Required]
        ...
        [Column("vs_respiratory_indicator", TypeName = "varchar(1)"), Required]
        public string VsRespiratoryIndicator { get; set; }

        [Column("vs_respiratory", TypeName = "varchar(1)"), Required]
        public string VsRespiratory { get; set; }

        [Column("vs_temperature_indicator", TypeName = "varchar(1)"), Required]
        public string VsTemperatureIndicator { get; set; }

        [Column("vs_temperature", TypeName = "varchar(1)"), Required]
        ...
        [Column("vs_oxygen_saturation_indicator", TypeName = "varchar(1)"), Required]
        public string VsOxygenSaturationIndicator { get; set; }

        [Column("vs_oxygen_saturation", TypeName = "varchar(1)"), Required]
        public string VsOxygenSaturation { get; set; }

        [Column("vs_pain_scale_indicator", TypeName = "varchar(1)"), Required]
        public string VsPainScaleIndicator { get; set; }

        [Column("vs_pain_scale", TypeName = "varchar(1)"), Required]
