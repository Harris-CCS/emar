...
namespace Emar.Data.Entities
{
    ...
    public partial class AllergyReactionView
    {
        ...
        [Column("patient_allergy_name", TypeName = "nvarchar(255)")]
        public string PatientAllergyName { get; set; }
        [Column("patient_allergy_severity", TypeName = "varchar(80)")]
        public string PatientAllergySeverity { get; set; }
        [Column("order_table")]
        [StringLength(19)]
