...
from   (values
			...
			,('NasalMedication', 3, 'Amount given', 1, 'FreeText', NULL, 0, NULL, NULL, 1, '^CAmount given:=')
			...
			,('IntraDermMedication', 5, 'Site', 1, 'DropDownListBox', NULL, 1, NULL, NULL, 1, '')
			,('IntraDermMedication', 6, 'Other site', 1, 'FreeText', NULL, 1, NULL, NULL, 1, '^CMedication administered to ^IV_Location=')
			...
			,('IntraOssMedication', 6, 'Other Site', 1, 'FreeText', NULL, 1, NULL, NULL, 1, '^CMedication administered to ^IV_Location=')
			...
			,('RectalMedication', 6, 'Patient administered medication after instruction by staff on correct technique', 1, 'CheckBox', NULL, 1, NULL, NULL, 1, '^D=Patient administered medication after instruction by staff on correct technique')
			,('RectalMedication', 7, 'Lubricant used for administration', 1, 'CheckBox', NULL, 1, NULL, NULL, 1, '^D=Lubricant used for administration')
			,('RectalMedication', 8, 'Medication retained after administration', 1, 'CheckBox', NULL, 1, NULL, NULL, 1, '^D=Medication retained after administration')	
			...
			,('TransDermMedication', 7, 'Skin cleansed prior to administration', 1, 'CheckBox', NULL, 1, NULL, NULL, 1, '^D=Skin cleansed prior to administration')
			,('TransDermMedication', 8, 'Shaving required prior to administration', 1, 'CheckBox', NULL, 1, NULL, NULL, 1, '^D=Shaving required prior to administration')
			...
			,('VaginalMedication', 8, 'Patient administered medication after instruction by staff on correct technique', 1, 'CheckBox', NULL, 1, NULL, NULL, 1, '^D=Patient administered medication after instruction by staff on correct technique')
			...
			,('VaginalMedication', 11, 'Medication retained after administration', 1, 'CheckBox', NULL, 1, NULL, NULL, 1, '^D=Medication retained after administration')	
			...
			,('SubcutanMedication', 5, 'Medication site', 1, 'DropDownListBox', NULL, 1, NULL, NULL, 1, '')
			,('SubcutanMedication', 6, 'Other site', 1, 'FreeText', NULL, 1, NULL, NULL, 1, '^CMedication administered to ^IV_Location=')
			,('SubcutanMedication', 7, 'Immunization', 1, 'CheckBox', NULL, 1, NULL, 'true', 1, '^D^Simmunizations=Medication is an immunization')
			,('SubcutanMedication', 8, 'Immunization site', 1, 'DropDownListBox', NULL, 1, NULL, NULL, 1, '')
			,('SubcutanMedication', 9, 'Vaccination information sheet given to patient', 1, 'CheckBox', NULL, 1, NULL, NULL, 1, '^D^Itram^^medsvc_vac_sheetgiven=Vaccination information sheet given to patient')
			...
			,('SubcutanMedication', 16, 'Other dose number', 1, 'FreeText', NULL, 1, NULL, NULL, 1, '^C^^^^medsvc_vac_dosenum=')
			,('SubcutanMedication', 17, 'Previous dose confirmed by', 1, 'DropDownListBox', NULL, 1, NULL, NULL, 1, '')
			,('SubcutanMedication', 18, 'Provided Emergency Use Authorization (EUA) fact sheet', 1, 'CheckBox', NULL, 1, NULL, NULL, 1, '^D^Itram^^medsvc_vac_EAUgiven=Provided Emergency Use Authorization (EUA) fact sheet')
			,('SubcutanMedication', 19, 'Provided a completed vaccination record card', 1, 'CheckBox', NULL, 1, NULL, NULL, 1, '^D^Itram^^medsvc_vac_Cardgiven=Provided a completed COVID-19 vaccination record card')
			...
			,('IVInIMedication', 3, 'Amount given', 1, 'FreeText', NULL, 0, NULL, NULL, 1, '^CAmount given:=')
			,('IVInIMedication', 4, 'Location', 1, 'DropDownListBox', NULL, 0, NULL, 'true', 1, '')
			,('IVInIMedication', 5, 'Other IV Site', 1, 'FreeText', NULL, 0, NULL, NULL, 1, '^Cinto^IV_Location=')
			,('IVInIMedication', 6, 'IV Number', 1, 'Information', NULL, 0, NULL, NULL, 1, '')
			,('IVInIMedication', 7, '1st IV', 1, 'CheckBox', NULL, 0, NULL, NULL, 1, '^D^IVSITE1=IV SITE #1')
			,('IVInIMedication', 8, '2nd IV', 1, 'CheckBox', NULL, 0, NULL, NULL, 1, '^D^IVSITE2=IV SITE #2')
			,('IVInIMedication', 9, '3rd IV', 1, 'CheckBox', NULL, 0, NULL, NULL, 1, '^D^IVSITE3=IV SITE #3')
			,('IVInIMedication', 10, '4th IV', 1, 'CheckBox', NULL, 0, NULL, NULL, 1, '^D^IVSITE4=IV SITE #4')
			...
			,('IVMedication', 2, 'Amount given', 1, 'FreeText', NULL, 0, NULL, NULL, 1, '^CAmount given:=')
			,('IVMedication', 3, 'IV number', 1, 'DropDownListBox', NULL, 0, NULL, 'true', 1, NULL)
			,('IVMedication', 4, 'Location', 1, 'DropDownListBox', NULL, 0, NULL, 'true', 1, NULL)
			...
			,('IVMedication', 10, 'Site', 1, 'DropDownListBox', NULL, 0, NULL, 'true', 1, NULL)
			...
			,('GenericGive', 5, 'Notify', 1, 'Notify', NULL, 0, NULL, NULL, 1, '^CNotified:=')
			...
			,('IntraMuscMedication', 3, 'Site ~~(non-antibiotic/immunization)', 1, 'DropDownListBox', NULL, 1, NULL, NULL, 1, '')
			,('IntraMuscMedication', 4, 'Other site ~~(non-antibiotic/immunization)', 1, 'FreeText', NULL, 1, NULL, NULL, 1, '^CMedication administered to ^IV_Location=')
			...
			,('IntraMuscMedication', 8, 'Site ~~(antibiotic)', 1, 'DropDownListBox', NULL, 1, NULL, NULL, 1, '')
			,('IntraMuscMedication', 9, 'Other site ~~(antibiotic)', 1, 'DropDownListBox', NULL, 1, NULL, NULL, 1, '^CMedication administered to ^IV_Location2=')
			...
			,('IntraMuscMedication', 13, 'Site ~~(immunization)', 1, 'DropDownListBox', NULL, 1, NULL, NULL, 1, '')
			,('IntraMuscMedication', 14, 'Other site ~~(immunization)', 1, 'DropDownListBox', NULL, 1, NULL, NULL, 1, '^CMedication administered to ^IV_Location^^^medsvc_vac_site=')
			...
			,('INtraMuscMedication', 19, 'Other dose number', 1, 'FreeText', NULL, 1, NULL, NULL, 1, '^C^^^^medsvc_vac_dosenum=')
			,('INtraMuscMedication', 20, 'Previous dose confirmed by', 1, 'DropDownListBox', NULL, 1, NULL, NULL, 1, '')
			...
			,('Assessment', 1, 'O2 Sat', 1, 'DropDownListBox', NULL, 1, NULL, NULL, 1, '')
			,('Assessment', 2, 'O2 Amount', 1, 'DropDownListBox', NULL, 1, NULL, NULL, 1, '')
			,('Assessment', 3, 'O2 Type', 1, 'DropDownListBox', NULL, 1, NULL, NULL, 1, '')
			,('Assessment', 4, 'Assessment notes', 1, 'FreeText', NULL, 1, NULL, NULL, 1, '^C^assessnotes=')
			...
			,('InhalationAssessment', 1, 'Peak-Flow prior', 1, 'CheckBox', NULL, 1, NULL, NULL, 1, '^D^peakflow^QX1197=Pre-administration assessment shows peak-flow')
			...
			,('InhalationAssessment', 5, 'Rhythm', 1, 'DropDownListBox', NULL, 1, NULL, NULL, 1, '')
			,('InhalationAssessment', 6, 'Ectopy', 1, 'DropDownListBox', NULL, 1, NULL, NULL, 1, '')
			,('InhalationAssessment', 7, 'St Changes', 1, 'DropDownListBox', NULL, 1, NULL, NULL, 1, '')
			...
			,('IVAssessment', 1, 'Connections checked prior to administration', 1, 'CheckBox', NULL, 1, NULL, NULL, 1, '^D=Connections checked prior to administration')
			,('IVAssessment', 2, 'Line traced prior to administration', 1, 'CheckBox', NULL, 1, NULL, NULL, 1, '^D=Line traced prior to administration')
			,('IVAssessment', 3, 'Catheter placement confirmed via flush prior to administration', 1, 'CheckBox', NULL, 1, NULL, NULL, 1, '^D=Catheter placement confirmed via flush prior to administration')
			,('IVAssessment', 4, 'IV site without s/sx of infiltration during medication administration', 1, 'CheckBox', NULL, 1, NULL, NULL, 1, '^D=IV site without signs or symptoms of infiltration during medication administration')
			,('IVAssessment', 5, 'No swelling during administration', 1, 'CheckBox', NULL, 1, NULL, NULL, 1, '^D=No swelling during administration')
			,('IVAssessment', 6, 'No drainage during administration', 1, 'CheckBox', NULL, 1, NULL, NULL, 1, '^D=No drainage during administration')
			,('IVAssessment', 7, 'IV flushed after administration', 1, 'CheckBox', NULL, 0, NULL, NULL, 1, '^D=No drainage during administration')
			,('IVAssessment', 8, 'Correct patient, time, route, dose and medication confirmed prior to administration', 1, 'CheckBox', NULL, 0, NULL, NULL, 1, '^D=Correct patient, time, route, dose and medication confirmed prior to administration')
			,('IVAssessment', 9, 'Patient advised of actions and side-effects prior to administration', 1, 'CheckBox', NULL, 0, NULL, NULL, 1, '^D=Patient advised of actions and side-effects prior to administration')
			,('IVAssessment', 10, 'Allergies confirmed and medications reviewed prior to administration', 1, 'CheckBox', NULL, 0, NULL, NULL, 1, '^D=Allergies confirmed and medications reviewed prior to administration')
			...
			,('IVFollowUp', 1, 'Titrating to patient response', 1, 'CheckBox', NULL, 0, NULL, 'true', 1, '^D^titrate=Titrating to patient response')
			,('IVFollowUp', 2, 'Dose increased', 1, 'CheckBox', NULL, 0, NULL, NULL, 1, '^D^dose=Dose increased^^U')
			,('IVFollowUp', 3, 'Dose decreased', 1, 'CheckBox', NULL, 0, NULL, NULL, 1, '^D^dose=Dose decreased^^U')
			
			,('StopTime', 1, 'Infusion Discontinued', 1, 'CheckBox', NULL, 0, NULL, 'true', 1, '^D=Infusion discontinued^^U')
			,('StopTime', 2, 'Date/Time ~~(infusionDiscontinued)', 1, 'DateTime', '', 0, NULL, NULL, 1, '^Con=')
			,('StopTime', 3, 'Totaling - HOURS ~~(infusionDiscontinued)', 1, 'DropDownListBox', NULL, 0, NULL, NULL, 1, '')
			,('StopTime', 4, 'Totaling - MINS ~~(infusionDiscontinued)', 1, 'DropDownListBox', NULL, 0, NULL, NULL, 1, '')
			,('StopTime', 5, 'Stop time unknown', 1, 'CheckBox', NULL, 0, NULL, NULL, 1, '^D^CORE_unknown_stoptime=Unknown stop time^^U')
			,('StopTime', 6, 'Continued upon Transfer', 1, 'CheckBox', NULL, 0, NULL, 'true', 1, '^D=Infusion continued upon transfer from emergency department^^U')
			,('StopTime', 7, 'Date/Time ~~(infusionContinuedUponTransfer)', 1, 'DateTime', '', 0, NULL, NULL, 1,'^Con=')
			,('StopTime', 8, 'Totaling - HOURS ~~(infusionContinuedUponTransfer)', 1, 'DropDownListBox', NULL, 0, NULL, NULL, 1, '')
			,('StopTime', 9, 'Totaling - MINS ~~(infusionContinuedUponTransfer)', 1, 'DropDownListBox', NULL, 0, NULL, NULL, 1, '')
			...
			,('VitalSigns', 5, 'PULSE', 1, 'FreeText', NULL, 0, NULL, NULL, 1, '^CPulse:=')
			,('VitalSigns', 6, ' ~~(pulseSelect1)', 1, 'DropDownListBox', NULL, 0, NULL, NULL, 1, '')
			,('VitalSigns', 7, ' ~~(pulseSelect2)', 1, 'DropDownListBox', NULL, 0, NULL, NULL, 1, '')
			,('VitalSigns', 8, 'TEMPERATURE', 1, 'FreeText', NULL, 0, NULL, NULL, 1, '^CTemperature:=')
			,('VitalSigns', 9, ' ~~(temperatureSelect1)', 1, 'DropDownListBox', NULL, 0, NULL, NULL, 1, '')
			,('VitalSigns', 10, ' ~~(temperatureSelect2)', 1, 'DropDownListBox', NULL, 0, NULL, NULL, 1, '')
			,('VitalSigns', 11, 'O2 SAT', 1, 'FreeText', NULL, 0, NULL, NULL, 1, '^CO2 Sat:=')
			,('VitalSigns', 12, 'on', 1, 'FreeText', NULL, 0, NULL, NULL, 1, '^Con=')
			,('VitalSigns', 13, 'MAP', 1, 'FreeText', NULL, 0, NULL, NULL, 1, '^CMap:=')
			,('VitalSigns', 14, ' ~~(mapSelect1)', 1, 'DropDownListBox', NULL, 0, NULL, NULL, 1, '')
			,('VitalSigns', 15, ' ~~(mapSelect2)', 1, 'DropDownListBox', NULL, 0, NULL, NULL, 1, '')
...
from   (values
			...
			,('IntraMuscMedication', 'Site ~~(non-antibiotic/immunization)', 1, 'Left deltoid', '^S^IV_Location=Medication administered to left deltoid^^left deltoid')
			,('IntraMuscMedication', 'Site ~~(non-antibiotic/immunization)', 2, 'Right deltoid', '^S^IV_Location=Medication administered to right deltoid^^right deltoid')
			,('IntraMuscMedication', 'Site ~~(non-antibiotic/immunization)', 3, 'Left buttock', '^S^IV_Location=Medication administered to left buttock^^left buttock')
			,('IntraMuscMedication', 'Site ~~(non-antibiotic/immunization)', 4, 'Right buttock', '^S^IV_Location=Medication administered to right buttock^^right buttock')
			,('IntraMuscMedication', 'Site ~~(non-antibiotic/immunization)', 5, 'Left hip', '^S^IV_Location=Medication administered to left hip^^left hip')
			,('IntraMuscMedication', 'Site ~~(non-antibiotic/immunization)', 6, 'Right hip', '^S^IV_Location=Medication administered to right hip^^right hip')
			,('IntraMuscMedication', 'Site ~~(non-antibiotic/immunization)', 7, 'Left thigh', '^S^IV_Location=Medication administered to left thigh^^left thigh')
			,('IntraMuscMedication', 'Site ~~(non-antibiotic/immunization)', 8, 'Right thigh', '^S^IV_Location=Medication administered to right thigh^^right thigh')
			,('IntraMuscMedication', 'Site ~~(non-antibiotic/immunization)', 9, 'Other IV sites', '^S^IV_Location=Other IV Site')

			,('IntraMuscMedication', 'Site ~~(antibiotic)', 1, 'Left deltoid', '^S^IV_Location=Medication administered to left deltoid^^left deltoid')
			,('IntraMuscMedication', 'Site ~~(antibiotic)', 2, 'Right deltoid', '^S^IV_Location=Medication administered to right deltoid^^right deltoid')
			,('IntraMuscMedication', 'Site ~~(antibiotic)', 3, 'Left buttock', '^S^IV_Location=Medication administered to left buttock^^left buttock')
			,('IntraMuscMedication', 'Site ~~(antibiotic)', 4, 'Right buttock', '^S^IV_Location=Medication administered to right buttock^^right buttock')
			,('IntraMuscMedication', 'Site ~~(antibiotic)', 5, 'Left hip', '^S^IV_Location=Medication administered to left hip^^left hip')
			,('IntraMuscMedication', 'Site ~~(antibiotic)', 6, 'Right hip', '^S^IV_Location=Medication administered to right hip^^right hip')
			,('IntraMuscMedication', 'Site ~~(antibiotic)', 7, 'Left thigh', '^S^IV_Location=Medication administered to left thigh^^left thigh')
			,('IntraMuscMedication', 'Site ~~(antibiotic)', 8, 'Right thigh', '^S^IV_Location=Medication administered to right thigh^^right thigh')
			,('IntraMuscMedication', 'Site ~~(antibiotic)', 9, 'Other IV sites', '^S^IV_Location=Other IV Site')

			,('IntraMuscMedication', 'Site ~~(immunization)', 1, 'Left deltoid', '^S^IV_Location=Medication administered to left deltoid^^left deltoid')
			,('IntraMuscMedication', 'Site ~~(immunization)', 2, 'Right deltoid', '^S^IV_Location=Medication administered to right deltoid^^right deltoid')
			,('IntraMuscMedication', 'Site ~~(immunization)', 3, 'Left buttock', '^S^IV_Location=Medication administered to left buttock^^left buttock')
			,('IntraMuscMedication', 'Site ~~(immunization)', 4, 'Right buttock', '^S^IV_Location=Medication administered to right buttock^^right buttock')
			,('IntraMuscMedication', 'Site ~~(immunization)', 5, 'Left hip', '^S^IV_Location=Medication administered to left hip^^left hip')
			,('IntraMuscMedication', 'Site ~~(immunization)', 6, 'Right hip', '^S^IV_Location=Medication administered to right hip^^right hip')
			,('IntraMuscMedication', 'Site ~~(immunization)', 7, 'Left thigh', '^S^IV_Location=Medication administered to left thigh^^left thigh')
			,('IntraMuscMedication', 'Site ~~(immunization)', 8, 'Right thigh', '^S^IV_Location=Medication administered to right thigh^^right thigh')
			,('IntraMuscMedication', 'Site ~~(immunization)', 9, 'Other IV sites', '^S^IV_Location=Other IV Site')

			,('IntraDermMedication', 'Site', 1, 'Left chest', '^S^IV_Location=Medication administered to left chest^QX1676^left chest')
			,('IntraDermMedication', 'Site', 2, 'Right chest', '^S^IV_Location=Medication administered to right chest^QX1676^right chest')
			,('IntraDermMedication', 'Site', 3, 'Left forearm', '^S^IV_Location=Medication administered to left forearm^QX1676^left forearm')
			,('IntraDermMedication', 'Site', 4, 'Right forearm', '^S^IV_Location=Medication administered to right forearm^QX1676^right forearm')
			,('IntraDermMedication', 'Site', 5, 'Left upper back', '^S^IV_Location=Medication administered to left upper back^QX1676^left upper back')
			,('IntraDermMedication', 'Site', 6, 'Right upper back', '^S^IV_Location=Medication administered to right upper back^QX1676^rigth upper back')
			,('IntraDermMedication', 'Site', 7, 'Left abdomen', '^S^IV_Location=Medication administered to left abdomen^QX1676^left abdomen')
			,('IntraDermMedication', 'Site', 8, 'Right abdomen', '^S^IV_Location=Medication administered to right abdomen^QX1676^right abdomen')
			,('IntraDermMedication', 'Site', 9, 'Other IV sites', '^S^IV_Location=Other IV Site')

			,('IntraOssMedication', 'Site', 1, 'Left proximal tibia', '^S^IV_Location=Medication administered to left proximal tibia^QX4747^left proximal tibia')
			,('IntraOssMedication', 'Site', 2, 'Right proximal tibia', '^S^IV_Location=Medication administered to right proximal tibia^QX4747^right proximal tibia')
			,('IntraOssMedication', 'Site', 3, 'Left distal tibia', '^S^IV_Location=Medication administered to left distal tibia^QX4747^left distal tibia')
			,('IntraOssMedication', 'Site', 4, 'Right distal tibia', '^S^IV_Location=Medication administered to right distal tibia^QX4747^right distal tibia')
			,('IntraOssMedication', 'Site', 5, 'Left femur', '^S^IV_Location=Medication administered to left femur^QX4747^left femur')
			,('IntraOssMedication', 'Site', 6, 'Right femur', '^S^IV_Location=Medication administered to right femur^QX4747^right femur')
			,('IntraOssMedication', 'Site', 7, 'Sternal', '^S^IV_Location=Medication administered to sternum^QX4747^sternum')
			,('IntraOssMedication', 'Site', 8, 'Other IV sites', '^S^IV_Location=Other IV Site')
			...
			,('IntraMuscMedication', 'IM (Not an antibiotic or immunization)', 0, 'Other site ~~(non-antibiotic/immunization)', '^CMedication administered to ^IV_Location=')
			...
			,('IntraMuscMedication', 'IM antibiotic', 0, 'Other site ~~(antibiotic)', '^CMedication administered to ^IV_Location2')
			...
			,('IntraMuscMedication', 'IM immunization', 0, 'Other site ~~(immunization)', '^CMedication administered to ^IV_Location^^^medsvc_vac_site')
			...
			,('SubcutanMedication', 'Medication site', 1, 'Left upper arm', '^S^IV_Location=Medication administered to left upper arm^QX216^left upper arm')
			,('SubcutanMedication', 'Medication site', 2, 'Right upper arm', '^S^IV_Location=Medication administered to right upper arm^QX216^right upper arm')
			,('SubcutanMedication', 'Medication site', 3, 'Left upper back', '^S^IV_Location=Medication administered to left upper back^QX216^left upper back')
			,('SubcutanMedication', 'Medication site', 4, 'Right upper back', '^S^IV_Location=Medication administered to right upper back^QX216^right upper back')
			,('SubcutanMedication', 'Medication site', 5, 'Left lower back', '^S^IV_Location=Medication administered to left lower back^QX216^left lower back')
			,('SubcutanMedication', 'Medication site', 6, 'Right lower back', '^S^IV_Location=Medication administered to right lower back^QX216^right lower back')
			,('SubcutanMedication', 'Medication site', 7, 'Left abdomen', '^S^IV_Location=Medication administered to left abdomen^QX216^left abdomen')
			,('SubcutanMedication', 'Medication site', 8, 'Right abdomen', '^S^IV_Location=Medication administered to right abdomen^QX216^right abdomen')
			,('SubcutanMedication', 'Medication site', 9, 'Left thigh', '^S^IV_Location=Medication administered to left thigh^QX216^left thigh')
			,('SubcutanMedication', 'Medication site', 10, 'Right thigh', '^S^IV_Location=Medication administered to right thigh^QX216^right thigh')
			,('SubcutanMedication', 'Medication site', 11, 'Other IV sites', '^S^IV_Location=IV Site')

			,('SubcutanMedication', 'Immunization site', 1, 'Left upper arm', '^S^IV_Location=Immunization administered to left upper arm^^left upper arm^medsvc_vac_site')
			,('SubcutanMedication', 'Immunization site', 2, 'Right upper arm', '^S^IV_Location=Immunization administered to right upper arm^^right upper arm^medsvc_vac_site')
			,('SubcutanMedication', 'Immunization site', 3, 'Left upper back', '^S^IV_Location=Immunization administered to left upper back^^left upper back^medsvc_vac_site')
			,('SubcutanMedication', 'Immunization site', 4, 'Right upper back', '^S^IV_Location=Immunization administered to right upper back^^right upper back^medsvc_vac_site')
			,('SubcutanMedication', 'Immunization site', 5, 'Left lower back', '^S^IV_Location=Immunization administered to left lower back^^left lower back^medsvc_vac_site')
			,('SubcutanMedication', 'Immunization site', 6, 'Right lower back', '^S^IV_Location=Immunization administered to right lower back^^right lower back^medsvc_vac_site')
			,('SubcutanMedication', 'Immunization site', 7, 'Left abdomen', '^S^IV_Location=Immunization administered to left abdomen^^left abdomen^medsvc_vac_site')
			,('SubcutanMedication', 'Immunization site', 8, 'Right abdomen', '^S^IV_Location=Immunization administered to right abdomen^^right abdomen^medsvc_vac_site')
			,('SubcutanMedication', 'Immunization site', 9, 'Left thigh', '^S^IV_Location=Immunization administered to left thigh^^left thigh^medsvc_vac_site')
			,('SubcutanMedication', 'Immunization site', 10, 'Right thigh', '^S^IV_Location=Immunization administered to right thigh^^right thigh^medsvc_vac_site')
			,('SubcutanMedication', 'Immunization site', 11, 'Other IV sites', '^S^IV_Location=Immunization administered to other site^^^^medsvc_vac_site')
			...
			,('StopTime', 'Infusion Discontinued', 0, 'Totaling - HOURS ~~(infusionDiscontinued)', '')
			,('StopTime', 'Infusion Discontinued', 0, 'Totaling - MINS ~~(infusionDiscontinued)', '')

			,('StopTime', 'Totaling - HOURS ~~(infusionDiscontinued)', 1, '1 hour', '^S=Total infusion time 1 hour')
			,('StopTime', 'Totaling - HOURS ~~(infusionDiscontinued)', 2, '2 hours', '^S=Total infusion time 2 hours')
			,('StopTime', 'Totaling - HOURS ~~(infusionDiscontinued)', 3, '3 hours', '^S=Total infusion time 3 hours')
			,('StopTime', 'Totaling - HOURS ~~(infusionDiscontinued)', 4, '5 hours', '^S=Total infusion time 5 hours')
			,('StopTime', 'Totaling - HOURS ~~(infusionDiscontinued)', 5, '10 hours', '^S=Total infusion time 10 hours')
			,('StopTime', 'Totaling - HOURS ~~(infusionDiscontinued)', 6, '15 hours', '^S=Total infusion time 15 hours')
			,('StopTime', 'Totaling - HOURS ~~(infusionDiscontinued)', 7, '20 hours', '^S=Total infusion time 20 hours')
			,('StopTime', 'Totaling - HOURS ~~(infusionDiscontinued)', 8, '23 hours', '^S=Total infusion time 23 hours')
			,('StopTime', 'Totaling - HOURS ~~(infusionDiscontinued)', 9, '>23 hours', '^S=Total infusion time greater than 23 hours')
			
			,('StopTime', 'Totaling - MINS ~~(infusionDiscontinued)', 1, '5 minutes', '^S=5 minutes')
			,('StopTime', 'Totaling - MINS ~~(infusionDiscontinued)', 2, '10 minutes', '^S=10 minutes')
			,('StopTime', 'Totaling - MINS ~~(infusionDiscontinued)', 3, '15 minutes', '^S=15 minutes')
			,('StopTime', 'Totaling - MINS ~~(infusionDiscontinued)', 4, '20 minutes', '^S=20 minutes')
			,('StopTime', 'Totaling - MINS ~~(infusionDiscontinued)', 5, '25 minutes', '^S=25 minutes')
			,('StopTime', 'Totaling - MINS ~~(infusionDiscontinued)', 6, '30 minutes', '^S=30 minutes')
			,('StopTime', 'Totaling - MINS ~~(infusionDiscontinued)', 7, '35 minutes', '^S=35 minutes')
			,('StopTime', 'Totaling - MINS ~~(infusionDiscontinued)', 8, '40 minutes', '^S=40 minutes')
			,('StopTime', 'Totaling - MINS ~~(infusionDiscontinued)', 9, '45 minutes', '^S=45 minutes')
			,('StopTime', 'Totaling - MINS ~~(infusionDiscontinued)', 10, '50 minutes', '^S=50 minutes')
			,('StopTime', 'Totaling - MINS ~~(infusionDiscontinued)', 11, '55 minutes', '^S=55 minutes')
			,('StopTime', 'Totaling - MINS ~~(infusionDiscontinued)', 12, '60 minutes', '^S=60 minutes')
			,('StopTime', 'Totaling - MINS ~~(infusionDiscontinued)', 13, '>60 minutes', '^S=greater than 60 minutes')
			

			,('StopTime', 'Continued upon Transfer', 0, 'Date/Time ~~(infusionContinuedUponTransfer)', '^Con=')
			,('StopTime', 'Continued upon Transfer', 0, 'Totaling - HOURS ~~(infusionContinuedUponTransfer)', '')
			,('StopTime', 'Continued upon Transfer', 0, 'Totaling - MINS ~~(infusionContinuedUponTransfer)', '')

			,('StopTime', 'Totaling - HOURS ~~(infusionContinuedUponTransfer)', 1, '1 hour', '^S=Total infusion time 1 hour')
			,('StopTime', 'Totaling - HOURS ~~(infusionContinuedUponTransfer)', 2, '2 hours', '^S=Total infusion time 2 hours')
			,('StopTime', 'Totaling - HOURS ~~(infusionContinuedUponTransfer)', 3, '3 hours', '^S=Total infusion time 3 hours')
			,('StopTime', 'Totaling - HOURS ~~(infusionContinuedUponTransfer)', 4, '5 hours', '^S=Total infusion time 5 hours')
			,('StopTime', 'Totaling - HOURS ~~(infusionContinuedUponTransfer)', 5, '10 hours', '^S=Total infusion time 10 hours')
			,('StopTime', 'Totaling - HOURS ~~(infusionContinuedUponTransfer)', 6, '15 hours', '^S=Total infusion time 15 hours')
			,('StopTime', 'Totaling - HOURS ~~(infusionContinuedUponTransfer)', 7, '20 hours', '^S=Total infusion time 20 hours')
			,('StopTime', 'Totaling - HOURS ~~(infusionContinuedUponTransfer)', 8, '23 hours', '^S=Total infusion time 23 hours')
			,('StopTime', 'Totaling - HOURS ~~(infusionContinuedUponTransfer)', 9, '>23 hours', '^S=Total infusion time greater than 23 hours')
			
			,('StopTime', 'Totaling - MINS ~~(infusionContinuedUponTransfer)', 1, '5 minutes', '^S=5 minutes')
			,('StopTime', 'Totaling - MINS ~~(infusionContinuedUponTransfer)', 2, '10 minutes', '^S=10 minutes')
			,('StopTime', 'Totaling - MINS ~~(infusionContinuedUponTransfer)', 3, '15 minutes', '^S=15 minutes')
			,('StopTime', 'Totaling - MINS ~~(infusionContinuedUponTransfer)', 4, '20 minutes', '^S=20 minutes')
			,('StopTime', 'Totaling - MINS ~~(infusionContinuedUponTransfer)', 5, '25 minutes', '^S=25 minutes')
			,('StopTime', 'Totaling - MINS ~~(infusionContinuedUponTransfer)', 6, '30 minutes', '^S=30 minutes')
			,('StopTime', 'Totaling - MINS ~~(infusionContinuedUponTransfer)', 7, '35 minutes', '^S=35 minutes')
			,('StopTime', 'Totaling - MINS ~~(infusionContinuedUponTransfer)', 8, '40 minutes', '^S=40 minutes')
			,('StopTime', 'Totaling - MINS ~~(infusionContinuedUponTransfer)', 9, '45 minutes', '^S=45 minutes')
			,('StopTime', 'Totaling - MINS ~~(infusionContinuedUponTransfer)', 10, '50 minutes', '^S=50 minutes')
			,('StopTime', 'Totaling - MINS ~~(infusionContinuedUponTransfer)', 11, '55 minutes', '^S=55 minutes')
			,('StopTime', 'Totaling - MINS ~~(infusionContinuedUponTransfer)', 12, '60 minutes', '^S=60 minutes')
			,('StopTime', 'Totaling - MINS ~~(infusionContinuedUponTransfer)', 13, '>60 minutes', '^S=greater than 60 minutes')
			...
			,('IVInIMedication', 'Location', 1, 'Left forearm', '^S^IV_Location=into left forearm^^left forearm')
			,('IVInIMedication', 'Location', 2, 'Right forearm', '^S^IV_Location=into right forearm^^right forearm')
			,('IVInIMedication', 'Location', 3, 'Left AC', '^S^IV_Location=into left antecubital^^left antecubital')
			,('IVInIMedication', 'Location', 4, 'Right AC', '^S^IV_Location=into right antecubital^^right antecubital')
			,('IVInIMedication', 'Location', 5, 'Left wrist', '^S^IV_Location=into left wrist^^left wrist')
			,('IVInIMedication', 'Location', 6, 'Right wrist', '^S^IV_Location=into right wrist^^right wrist')
			,('IVInIMedication', 'Location', 7, 'Left hand', '^S^IV_Location=into left hand^^left hand')
			,('IVInIMedication', 'Location', 8, 'Right hand', '^S^IV_Location=into right hand^^right hand')
			,('IVInIMedication', 'Location', 9, 'Left EJ', '^S^IV_Location=into left EJ^^left EJ')
			,('IVInIMedication', 'Location', 10, 'Right EJ', '^S^IV_Location=into right EJ^^right EJ')
			,('IVInIMedication', 'Location', 11, 'Left scalp', '^S^IV_Location=into left scalp^^left scalp')
			,('IVInIMedication', 'Location', 12, 'Right scalp', '^S^IV_Location=into right scalp^^right scalp')
			,('IVInIMedication', 'Location', 13, 'Left shoulder', '^S^IV_Location=into left shoulder^^left shoulder')
			,('IVInIMedication', 'Location', 14, 'Right shoulder', '^S^IV_Location=into right shoulder^^right shoulder')
			,('IVInIMedication', 'Location', 15, 'Left groin', '^S^IV_Location=into left groin^^left groin')
			,('IVInIMedication', 'Location', 16, 'Right groin', '^S^IV_Location=into right groin^^right groin')
			,('IVInIMedication', 'Location', 17, 'Left leg', '^S^IV_Location=into left leg^^left leg')
			,('IVInIMedication', 'Location', 18, 'Right leg', '^S^IV_Location=into right leg^^right leg')
			,('IVInIMedication', 'Location', 19, 'Left foot', '^S^IV_Location=into left foot^^left foot')
			,('IVInIMedication', 'Location', 20, 'Right foot', '^S^IV_Location=into right foot^^right foot')
			...
			,('IVInIMedication', 'Location', 26, 'Left tibia', '^S^IV_Location=into left tibia^^left tibia')
			,('IVInIMedication', 'Location', 27, 'Right tibia', '^S^IV_Location=into right tibia^^right tibia')
		...
		-- IV  template ------------------------------------------------
			,('IVMedication', 'Location', 1, 'Left forearm', '^S^IV_Location=into left forearm^QX1115^left forearm')
			,('IVMedication', 'Location', 2, 'Right forearm', '^S^IV_Location=into right forearm^QX1116^right forearm')
			,('IVMedication', 'Location', 3, 'Left AC', '^S^IV_Location=into left antecubital^QX1039^left antecubital')
			,('IVMedication', 'Location', 4, 'Right AC', '^S^IV_Location=into right antecubital^QX1040^right antecubital')
			,('IVMedication', 'Location', 5, 'Left wrist', '^S^IV_Location=into left wrist^QX4513^left wrist')
			,('IVMedication', 'Location', 6, 'Right wrist', '^S^IV_Location=into right wrist^QX4514^right wrist')
			,('IVMedication', 'Location', 7, 'Left hand', '^S^IV_Location=into left hand^QX1037^left hand')
			,('IVMedication', 'Location', 8, 'Right hand', '^S^IV_Location=into right hand^QX1038^right hand')
			,('IVMedication', 'Location', 9, 'Left EJ', '^S^IV_Location=into left EJ^QX1117^left EJ')
			,('IVMedication', 'Location', 10, 'Right EJ', '^S^IV_Location=into right EJ^QX1118^right EJ')
			,('IVMedication', 'Location', 11, 'Left scalp', '^S^IV_Location=into left scalp^^left scalp')
			,('IVMedication', 'Location', 12, 'Right scalp', '^S^IV_Location=into right scalp^^right scalp')
			,('IVMedication', 'Location', 13, 'Left shoulder', '^S^IV_Location=into left shoulder^^left shoulder')
			,('IVMedication', 'Location', 14, 'Right shoulder', '^S^IV_Location=into right shoulder^^right shoulder')
			,('IVMedication', 'Location', 15, 'Left groin', '^S^IV_Location=into left groin^^left groin')
			,('IVMedication', 'Location', 16, 'Right groin', '^S^IV_Location=into right groin^^right groin')
			,('IVMedication', 'Location', 17, 'Left leg', '^S^IV_Location=into left leg^^left leg')
			,('IVMedication', 'Location', 18, 'Right leg', '^S^IV_Location=into right leg^^right leg')
			,('IVMedication', 'Location', 19, 'Left foot', '^S^IV_Location=into left foot^^left foot')
			,('IVMedication', 'Location', 20, 'Right foot', '^S^IV_Location=into right foot^^right foot')
			...
			,('IVMedication', 'Location', 26, 'Left tibia', '^S^IV_Location=into left tibia^^left tibia')
			,('IVMedication', 'Location', 27, 'Right tibia', '^S^IV_Location=into right tibia^^right tibia')
