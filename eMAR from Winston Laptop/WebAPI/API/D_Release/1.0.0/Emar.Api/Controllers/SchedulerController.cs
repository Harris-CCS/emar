...
namespace Emar.Api.Controllers
{
    ...
    public class SchedulerController : ControllerBase
    {
        ...
        [HttpGet("{brandName}", Name = nameof(GetSchedulerOptions))]
            ...
            )
        {
            ...
            try
            {
                ret = _orderService.GetSchedulerSetupData(siteId.Value, brandName);
            }
            catch (Exception ex)
            {
        ...
        [HttpGet("frequencies", Name = nameof(GetSchedulerFrequencies))]
        ...
        [HttpGet("routes", Name = nameof(GetSchedulerRoutes))]
        ...
        [HttpGet("units", Name = nameof(GetSchedulerUnits))]
