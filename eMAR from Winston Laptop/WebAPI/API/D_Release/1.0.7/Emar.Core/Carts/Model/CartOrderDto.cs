...
namespace Emar.Core.Carts.Model
{
    public class CartOrderDto : OrderBase
    {
        ...
        //The name of the tab that the UI should load in the remembered lists on Med Svc.
        //Currently, we're only implementing this for groups.
        //Winston Murdock, 09/23/2022.  PC-27538
        public string? TabToLoad { get; set; }

        //The pathway to show (i.e. already have opened) when defaulting to the groups tab on Med Svc.
        //Winston Murdock, 09/23/2022.  PC-27538
