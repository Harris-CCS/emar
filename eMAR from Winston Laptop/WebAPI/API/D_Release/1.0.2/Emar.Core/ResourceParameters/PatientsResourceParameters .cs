namespace Emar.Core.ResourceParameters
{
    public class PatientsResourceParameters : BaseResourceParameters
    {
        ...
        /// </summary>
        public bool IncludeMyPatientsOnly { get; set; }
        /// <summary>
        ...
        public string PharmacyVerificationStatus { get; set; }
        /// <summary>
        /// Pharmacy Verification Status to filter on.
        /// </summary>
        /// 

        public bool UpcomingOrdersOnly { get; set; }
        /// <summary>
        /// Whether or not to only return "upcoming" orders.
        /// </summary>
        
        public bool OnlySaveDefaults { get; set; }
        /// <summary>
        /// Specifying that we're only saving the user's defaults here and not getting the list of patients.
        /// </summary>
        /// 

        public bool OnlyGetDefaults { get; set; }
        /// <summary>
        /// Specifying that we're only getting the user's defaults here and not getting the list of patients.
        /// </summary>
    }
}
