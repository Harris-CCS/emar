...
namespace Emar.Core.Orders.Service
{
    public class OrderService : IOrderService
    {
        ...
        public SchedulerOptionsDto GetSchedulerSetupData(int siteId, EmarOrderType itemType, int itemId, int? duration = null, int? durationUnitId = null)
        {
            ...
            var antimicrobialRequiredIndicators = _orderRepository.GetAntimicrobialRequiredIndicators(siteId, medications);
            var administrations = _orderRepository.GetSchedulerAdministrations(siteId, itemType, itemId, _siteRepository.DateTimeOffsetNow(siteId), null, duration, durationUnitId);
