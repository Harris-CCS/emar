...
namespace Emar.Core.Orders.Service
{
    public class OrderService : IOrderService
    {
        ...
        public void UpdatePatientOrderInteractionsAndReactions(long patientId, List<int>? medicationIds = null)
        {
            ...
            foreach (var order in activeOrders)
            {
                ...
                UpdateOrderInteractionsAndReactions(siteId, patientId, order.Id, order.MedicationId, order.AddUserId, EmarOrderType.PatientOrder, items, newOrders, existingOrders, cartOrders);
            }
            foreach (var order in cartOrders)
            {
                ...
                UpdateOrderInteractionsAndReactions(siteId, patientId, order.Id, order.MedicationId, order.UserId, EmarOrderType.PatientCartOrder, items, newOrders, existingOrders, cartOrders);
            }
        }
