...
export class OrderHoverComponent implements OnInit, OnDestroy {
  ...
  onClickAction(admin: OrderAdministration, order: Order, action: AdministrationAction): void {
    ...
    if (MOCKUP) {
      ...
      if (action.availableAction.toLowerCase() === 'repeat' 
        ...
        console.log('BEfore launchMedComposer: action: ', action)

        // if (action.availableAction.toLowerCase() === 'repeat') {
        //   // get the cancel template and link
        ...
        //   let cancelResponse = this.patientMedOrderService
        //     .postOrderAction(cancelOrderAction)
        //     .subscribe(data => {
        //       console.log('RESULT POST ACTION', data);
        //       console.log('SUBSCRIBE OVER: CANCEL template data: ', data);
        ...
        //       //   console.log('POST ACTION completed: patientMedOrderStoreService: fetchPatientMedOrder')
        ...
        //     console.log('AFter SUBSCRIBE OVER: CANCEL cancelResponse: ', cancelResponse);
        // }
        ...
        this.patientMedOrderService.updateRequest.emit();
  ...
  launchMedComposer(medId: number, medData: object, action: string): void {
    ...
    // this.composerSchedulerService.setInitialComposerData({ action: 'add', source: 'patient-order', med: medData });
