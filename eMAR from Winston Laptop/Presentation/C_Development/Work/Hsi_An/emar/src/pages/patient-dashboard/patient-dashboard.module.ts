...
import { PatientAdminstrationsInfoModalComponent } from '../patient-administration/patient-adminstrations-info-modal.component';
import { AdministrationsModalComponent } from './administrations-modal/administrations-modal.component';
...
@NgModule({
  declarations: [
    ...
    PatientAdminstrationsInfoModalComponent,
    AdministrationsModalComponent
  ],
  imports: [
    CommonModule,
