...
import { ExternalComponent } from 'src/shared/component/external/external.component'
...
import { ComposerMainComponent } from '../pages/composer-main/composer-main.component';
...
const routes: Routes = [
    ...
    // { path: 'patients/:patientId', component: PatientDashboardComponent, data: {title: 'Patient Dashboard'} },
    // { path: 'patients/:patientId/orders', component: OrderEntryComponent, data: {title: 'Medication Services'} },
    // { path: 'patients/:patientId/:dest', component: OrderEntryComponent, data: {title: 'Medication Services'} },
    ...
    // { path: 'patients/:id/orders/:idOrder', component: ComposerMainComponent, data: { title: 'Composer' } },
    // { path: 'patients/:id/orders/:idOrder/new-order/:medId', component: ComposerMainComponent, data: { title: 'Composer' } },

    { path: 'notauth', component: NotAuthComponent },
    { path: 'not-found', component: ErrorPageComponent, data: { message: 'Page not found!' } },
    { path: 'timeout', component: ErrorPageComponent, data: { message: 'Your session timed out. Please log again in PulseCheck.' } },
