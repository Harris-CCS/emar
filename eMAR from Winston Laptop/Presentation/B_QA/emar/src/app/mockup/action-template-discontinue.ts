...
export const ACTION_TEMPLATE_DISCONTINUE: GivenTemplate  = {
    "id": 2,
    "name": "Discontinue",
    "promptGroups": [
        {
            "id": 1,
            "name": "Discontinue",
            "displayTitle": "Discontinue Reasons",
            "prompts": [
                {
                    "id": 1,
                    "promptGroupId": 1,
    ...
    "saveButtonText": "Discontinue",
    "cancelButtonText": "Cancel",
    "link": {
        "href": "http://localhost:51044/api/Template/Disconitnue"
    }
}
