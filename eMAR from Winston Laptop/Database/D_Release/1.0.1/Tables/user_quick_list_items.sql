...
alter table [dbo].[user_quick_list_items]
add constraint [fk__user_quick_list_items__duration_units] foreign key ([duration_unit_id]) references [dbo].[duration_units] ([id]);
go
...
execute [sys].[sp_addextendedproperty]
    @name       = N'MS_Description'
  , @value      = N'This table contains medications preferred list for the user quick list tab'
  , @level0type = N'SCHEMA'
  , @level0name = N'dbo'
  , @level1type = N'TABLE'
  , @level1name = N'user_quick_list_items';
...
execute [sys].[sp_addextendedproperty]
    @name       = N'MS_Description'
  , @value      = N'Person identifier that owns this medication list record (Foreign Key to users table)'
  , @level0type = N'SCHEMA'
  , @level0name = N'dbo'
  , @level1type = N'TABLE'
  , @level1name = N'user_quick_list_items'
...
execute [sys].[sp_addextendedproperty]
    @name       = N'MS_Description'
  , @value      = N'Administration duration in minutes'
  , @level0type = N'SCHEMA'
  , @level0name = N'dbo'
  , @level1type = N'TABLE'
  , @level1name = N'user_quick_list_items'
