create table [dbo].[patients]
    ...
    , [disposition_type_code]          [varchar](4) null     ---- [exittype]
    , [disposition_code]               [varchar](4) null     ---- [exitcode]
...
execute [sys].[sp_addextendedproperty] 
    @name = N'MS_Description'
  , @value = N'Datetime patient is_active flag was set to inactive.'
  , @level0type = N'SCHEMA'
  , @level0name = N'dbo'
  , @level1type = N'TABLE'
  , @level1name = N'patients'
...
execute [sys].[sp_addextendedproperty] 
    @name = N'MS_Description'
  , @value = N'Datetime patient visit / encounter began'
  , @level0type = N'SCHEMA'
  , @level0name = N'dbo'
  , @level1type = N'TABLE'
  , @level1name = N'patients'
...
go
EXEC sp_addextendedproperty @name = N'MS_Description',
    @value = N'Disposition type (code) of a patient',
    @level0type = N'SCHEMA',
    @level0name = N'dbo',
    @level1type = N'TABLE',
    @level1name = N'patients',
    @level2type = N'COLUMN',
    @level2name = N'disposition_type_code';

go
EXEC [sys].[sp_addextendedproperty] @name = N'MS_Description'
  , @value = N'Disposition code of a patient'
  , @level0type = N'SCHEMA'
  , @level0name = N'dbo'
  , @level1type = N'TABLE'
  , @level1name = N'patients'
  , @level2type = N'COLUMN'
  , @level2name = N'disposition_code'