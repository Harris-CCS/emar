...
if '$(load_data)' = 'sample'
   or  ('$(load_data)' = 'live'
    ...
    begin
        ...
        :r ..\Scripts\Data-Loader\development_data\frequency_schedules.sql
        ...
        :r ..\Scripts\Data-Loader\site_data\order_administration_available_actions.sql
        :r ..\Scripts\Data-Loader\global_data\order_available_actions.sql
        :r ..\Scripts\Data-Loader\site_data\order_available_actions.sql
        ...
        :r ..\Scripts\Data-Loader\site_data\department_preferred_list_items.sql
        ...
        :r ..\Scripts\Data-Loader\development_data\preferred_frequency_schedules.sql
        :r ..\Scripts\Data-Loader\development_data\preferred_medication_doses.sql
        :r ..\Scripts\Data-Loader\development_data\preferred_medication_routes.sql
        ...
        :r ..\Scripts\Data-Loader\phi_data\user_patients.sql
        execute [dbo].[load_user_quick_list_items]
        :r ..\Scripts\Data-Loader\user_data\user_settings.sql
        ...
        :r ..\Scripts\Data-Loader\development_data\generate_random_orders_to_chris_patients.sql
...
print 'Begin: Drop External Reference Procedures';
if '$(is_bacpac_build)'='True'
begin
print 'is_bacpac_build=$(is_bacpac_build)';
...
---
print 'Begin: Perform ibex customizations';
if  ('$(load_data)' = 'sample'
or   '$(load_data)' = 'live')
and @does_ibex_exist = 1
    begin
        execute('drop table if exists [ibex].[dbo].[emar_update_queue];')
    end;
