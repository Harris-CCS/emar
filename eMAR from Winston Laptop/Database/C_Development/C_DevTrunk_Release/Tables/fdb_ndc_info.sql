create table [dbo].[fdb_ndc_info]
	...
	, [dose_form] [varchar](30) NULL
	, [route] [varchar](40) NULL
	, [drugcat] [numeric](8, 0) NULL
...
create index [ix__fdb_ndc_info__MEDID_string] on [dbo].[fdb_ndc_info]
    ([MEDID_string] asc) 
      include
    ([medid], [ndc]);
go

create index [ix__fdb_ndc_info__ROUTED_GEN_ID] on [dbo].[fdb_ndc_info]
    ([ROUTED_GEN_ID])
      include
    ([ndc],[base_ndc],[MEDID_string]);
go
...
execute [sys].[sp_addextendedproperty] 
    @name = N'MS_Description'
  , @value = N'Drug dose form.'
  , @level0type = N'SCHEMA'
  , @level0name = N'dbo'
  , @level1type = N'TABLE'
  , @level1name = N'fdb_ndc_info'
  , @level2type = N'COLUMN'
  , @level2name = N'dose_form';
go
...
execute [sys].[sp_addextendedproperty] 
    @name = N'MS_Description'
  , @value = N'Drug category.'
  , @level0type = N'SCHEMA'
  , @level0name = N'dbo'
  , @level1type = N'TABLE'
  , @level1name = N'fdb_ndc_info'
  , @level2type = N'COLUMN'
  , @level2name = N'drugcat';
go
