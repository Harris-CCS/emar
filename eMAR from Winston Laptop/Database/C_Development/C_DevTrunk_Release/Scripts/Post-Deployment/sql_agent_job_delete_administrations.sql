...
-- delete future pharmacy notification adminitrations for inactive patients that have no actions 
DELETE pna
FROM pharmacy_notification_administrations pna
JOIN @order_admin_delete oad ON pna.order_administration_id=oad.order_administration_id;
