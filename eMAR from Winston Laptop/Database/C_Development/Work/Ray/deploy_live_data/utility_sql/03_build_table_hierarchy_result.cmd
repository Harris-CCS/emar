...
@echo ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
@echo "%pgm_sqlcmd%" -S %server_name% -i "table_hierarchy_list.sql" -o "build_table_hierarchy.txt" -v emar_base=%emar_base%
      "%pgm_sqlcmd%" -S %server_name% -i "table_hierarchy_list.sql" -o "build_table_hierarchy.txt" -v emar_base=%emar_base%
