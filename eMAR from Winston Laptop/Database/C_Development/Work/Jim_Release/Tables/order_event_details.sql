...
CREATE NONCLUSTERED INDEX [ix__order_event_details__order_event_id] ON [dbo].[order_event_details]
    ([order_event_id])
    INCLUDE ([id],[prompt_id],[prompt_text],[entered_text],[chart_markup]);
GO
