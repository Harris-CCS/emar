...
LVL: 002 SEQ: 004 TBL: dbo.ids_discrepancy_retries
...
:r ..\Scripts\Data-Loader\export_procedures\export_ibex_users.sql
        ...
        :r ..\Scripts\Data-Loader\global_data\prn_indications.sql
...
declare 
  ...
  , @sql_agent_attach_schedule              nvarchar(max);
...
:r ..\Scripts\Post-Deployment\sql_agent_job_clear_notifications.sql
:r ..\Scripts\Post-Deployment\sql_agent_job_delete_administrations.sql
...
if @does_ibex_exist = 1
    begin
        :r "..\Scripts\Post-Deployment\sql_agent_job_complete_long_running_ids.sql"
        :r "..\ibex_custom_updates\Database_Configuration\enable_broker.sql"
        :r "..\ibex_custom_updates\Tables\emar_update_queue.sql"
        :r "..\ibex_custom_updates\Tables\emar_alg_medication_id_cache.sql"
        :r "..\ibex_custom_updates\Tables\emar_hie_alg_medication_id_cache.sql"
        :r "..\ibex_custom_updates\Tables\emar_hie_meds_medication_id_cache.sql"
        :r "..\ibex_custom_updates\Tables\emar_update_queue_errors.sql"
        :r "..\ibex_custom_updates\Tables\ids_entries_stamped_as_complete.sql"
        :r "..\ibex_custom_updates\Functions\Scalar-values Functions\emar_is_device_pulled_in_from_ibex.sql"
        :r "..\ibex_custom_updates\Functions\Scalar-values Functions\IfStringIsNullOrWhiteSpaceThen.sql"
        :r "..\ibex_custom_updates\Functions\Table-values Functions\emar_patient_allergies_retrieve_fn.sql"
        :r "..\ibex_custom_updates\Functions\Table-values Functions\emar_patient_medications_retrieve_fn.sql"
        ...
        :r "..\ibex_custom_updates\Stored_Procedures\emar_alg_medication_id_update.sql"
        :r "..\ibex_custom_updates\Stored_Procedures\emar_update_queue_log_error.sql"
        :r "..\ibex_custom_updates\Stored_Procedures\complete_hung_ids_entries.sql"
        ...
        :r "..\ibex_custom_updates\Triggers\emar_alg_u.sql"
        :r "..\ibex_custom_updates\Triggers\emar_hie_alg_u.sql"
        :r "..\ibex_custom_updates\Triggers\emar_hie_meds_u.sql"
        ...
        :r "..\ibex_custom_updates\Views\emar_devices_to_pull_in_from_ibex.sql"
    end;
