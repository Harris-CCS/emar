...
from  (values
    ...
    ('Pending'           , 'Modify'             , null, 0),
    ('Pending'           , 'OrderDiscontinue'   , null, 0),
    ('Pending'           , 'Repeat'             , null, 0),
    ('Pending'           , 'Cosign'             , null, 0),
    ('Pending'           , 'Give'               , null, 1),
    ('Pending'           , 'PharmVerification'  , null, 0),
    ('Pending'           , 'Hold'               , null, 0),
    ('OnGoing'           , 'OrderDiscontinue'   , null, 0),
    ('OnGoing'           , 'Repeat'             , null, 0),
    ('OnGoing'           , 'Cosign'             , null, 0),
    ('OnGoing'           , 'Give'               , 1   , 1),
 --   ('OnGoing'           , 'Complete'           , null, 0),  -- Complete action removed 
 --   ('OnGoing'           , 'FollowUp'           , null, 0),  -- All followup should be at administration level
    ('OnGoing'           , 'PharmVerification'  , null, 0),
    ('OnGoing'           , 'Hold'               , null, 0),
    ('OnHold'            , 'Cancel'             , null, 0),
    ('OnHold'            , 'Delete'             , null, 0),
	('OnHold'            , 'Modify'             , null, 0),
    ('OnHold'            , 'OrderDiscontinue'   , null, 0),
    ('OnHold'            , 'Repeat'             , null, 0),
    ('OnHold'            , 'Cosign'             , null, 0),
    ('OnHold'            , 'Give'               , null, 1),
    ('OnHold'            , 'PharmVerification'  , null, 0),
    ('OnHold'            , 'Unhold'             , null, 0),
    ('PendingDiscontinue', 'CompleteDiscontinue', null, 0),
    ('PendingDiscontinue', 'Repeat'             , null, 0),
    ('PendingDiscontinue', 'Cosign'             , null, 0),
    ('PendingDiscontinue', 'PharmVerification'  , null, 0),
    ('Discontinued'      , 'Repeat'             , null, 0),
    ('Discontinued'      , 'PharmVerification'  , null, 0),
    ('Completed'         , 'Repeat'             , null, 0),
    ('Completed'         , 'PharmVerification'  , null, 0),
    ('Cancelled'         , 'PharmVerification'  , null, 0)) as [vals]
    (
      [order_status]
    , [available_action_id]
    , [is_pit]
...
2/8/21 Commentted lines added so new actions will be added to all sites
2/20/21  Delete added to remove unneeded actions for all sites
******************************************************************/
...
--   This will check for adding a new site not already in the order_available_actions
--               and [site].[id] not in
--                (
--                    select distinct 
--                           [id][site_id]
     ...
     on [source].[site_id] = [target].[site_id]
        ...
        and [source].[available_action_id] = [target].[available_action_id]
         when not matched by target
           ...
           values
         ([site_id], [order_status], [available_action_id], [is_pit], [is_prn_only])
-- Add delete to remove unmatched actions for each site
