...
add constraint [df__group_list_items__duration_in_minutes] default ((0)) for [duration_in_minutes];
go
...
alter table [dbo].[group_list_items]
add constraint [fk__group_list_items__medications] foreign key ([medication_id]) references [dbo].[medications] ([id]);
go

alter table [dbo].[group_list_items]
add constraint [fk__group_list_items__duration_units] foreign key ([duration_unit_id]) references [dbo].[duration_units] ([id]);
go
