...
begin
    ...
    ****************************************/
    ...
    select
      ...
      , case
	      when [source].[source_entity] = 'IGNORE' then NULL
		  else [source].[target_site_id]
		end   
    ...
    if (
        ...
        begin
            ...
            *************************************/
            ...
            where [source].[target_id] is null and [source].[target_site_id] is not null;
