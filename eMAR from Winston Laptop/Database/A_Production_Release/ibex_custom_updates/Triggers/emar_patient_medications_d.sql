print 'create trigger [ibex].[dbo].[hie_meds].[emar_patient_medications_d];';

set @template = N'
create or alter trigger [dbo].[emar_patient_medications_d] on [dbo].[hie_meds] after delete as
begin
...
print 'create trigger [ibex].[dbo].[alg].[emar_patient_medications2_d];';

set @template = N'
create or alter trigger [dbo].[emar_patient_medications2_d] on [dbo].[alg] after delete as
begin
   ...
   where  [d].[type] = ''M'' and [patients].[emar_pat] = ''Y'';
end;
';
