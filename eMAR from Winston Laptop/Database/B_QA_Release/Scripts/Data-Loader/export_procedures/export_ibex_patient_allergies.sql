...
--                  , isnull([sev].[misc2],[result].[severity]) [severity]
             ...
             left join [<@export_database_name>].[dbo].[idx] [sev] on [result].[severity]=[sev].[id] and [sev].type=''LR'' and [sev].[site]=[result].[site]
             left join [<@export_database_name>].[dbo].[idx] [src] on [result].[source]=[src].[id] and [src].type=''LS'' and [src].[site]=[result].[site]
             order by [ibex]
                    , [add_datetime]
                    , [name]
                    , [parent_drug_name];
