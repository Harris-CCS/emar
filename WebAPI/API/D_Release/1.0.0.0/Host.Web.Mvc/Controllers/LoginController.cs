...
namespace Host.Web.Mvc.Controllers
{
    ...
    {
        private readonly UserAccountService _userAccountSvc;
        private readonly ISiteService _siteSvc;
        private readonly IUserService _userService;

        public LoginController(UserAccountService userAccountSvc, ISiteService siteSvc, IUserService userService)
        {
