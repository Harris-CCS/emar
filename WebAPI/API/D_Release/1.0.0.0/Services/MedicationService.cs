...
namespace Services
{
    ...
    public class MedicationService : IMedicationService
    {
        ...
        public async Task<DomainModel.Group> GetMedicationGroup(User user, Site site, DomainModel.Group group, string patientId = null)
        {
            ...
            using (var con = new SqlConnection(DB.GetConnectionString()))
            {
                ...
                foreach (var med in medications)
                {
                    ...
                    if (components.Any())
                    {
                        ...
                        {
                            if (ShouldHaveIndication(Convert.ToInt32(component.DrugCategoryId), site, con))
