...
namespace Services
{
    public class SiteService : ISiteService
    {
        ...
        public SiteService(ISiteRepository siteRepository, IDepartmentRepository departmentRepository, IAreaRepository areaRepository, UserAccountService userAccount, IUserService userService, IPatientRepository patientRepository, IUserMappingRepository userMappingRepository)
        {
