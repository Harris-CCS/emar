...
namespace PulseCheck.API
{
    ...
    public class RazorEngineConfig
    {
        ...
        public static void CompileTemplates()
        {
            ...
            {
                { DomainModel.Constants.EmailTemplates.NEW_ACCOUNT, "NewAccountEmail" },
                { DomainModel.Constants.EmailTemplates.PASSWORD_RESET, "PasswordResetEmail" },
                { DomainModel.Constants.EmailTemplates.DEVICE_AUTHORIZATION, "DeviceAuthorizationEmail" },
            };
            ...
            foreach (var templateKey in templates.Keys)
            {
                ...
                Engine.Razor.Compile(templateText, templateKey, typeof(DomainModel.MobileEmail));
            }
        } 
    }
}