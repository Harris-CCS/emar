...
namespace PulseCheck.Utilities
{
    ...
    public class Transaction : ITransactionUtility
    {
        ...
        public int AddTransaction()
        {
            ...
            {
                if (Values[Constants.Date] is DateTime)
                {
                    Values[Constants.Date] = _time.DateTimeToStringNoSeconds((DateTime)Values[Constants.Date]);
                }
                else
                {
            ...
            {
                if (Values[Constants.ThruDate] is DateTime)
                {
                    Values[Constants.ThruDate] = _time.DateTimeToStringNoSeconds((DateTime)Values[Constants.ThruDate]);
                }
                else
                {
