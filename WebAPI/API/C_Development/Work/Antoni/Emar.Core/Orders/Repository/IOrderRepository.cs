...
namespace Emar.Core.Orders.Repository
{
    ...
    {
        PagedList<Order> GetOrders(long? patientId, OrdersResourceParameters resourceParameters);
        Order GetOrder(long orderId, OrdersResourceParameters resourceParameters);
