...
#if DEBUG
            if(ConfigurationManager.AppSettings.AllKeys.Any(x=>x == "TestApiBaseAddress"))
                apiBaseAddress = ConfigurationManager.AppSettings["TestApiBaseAddress"];
#endif
...
#if DEBUG
            if (ConfigurationManager.AppSettings.AllKeys.Any(x => x == "TestIdentityServerBaseAddress"))
                idBaseAddress = ConfigurationManager.AppSettings["TestIdentityServerBaseAddress"];
#endif
