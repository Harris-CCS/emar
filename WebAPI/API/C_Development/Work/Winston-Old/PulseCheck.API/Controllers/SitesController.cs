...
{ 
    ...
    public class SitesController : ControllerBase
    {
        ...
        public SitesController(ISiteManager siteManager, IUserManager userManager)
        {
        ...
        public async Task<IEnumerable<Site>> GetV1()
        {
            ...
            return await _siteManager.GetSitesBySubjectIdAsync(subjectId);
        }
        ...
        public async Task<Site> GetSiteV1(byte siteId)
        {
            ...
            var site = await _siteManager.GetSiteByIdAsync(siteId, true);
        ...
        public async Task<Department> GetDepartmentV1(string dept, string expand = "")
        {
            var userId = _authUtil.GetAuthenticatedUserId(User);
            var user = await _userManager.GetUserByIdAsync(userId);
            var department = await _siteManager.GetDepartmentByKeyAsync(user.SiteId, dept, user, false);
            department.Patients = await _siteManager.GetPatientsBySiteAndDeptAsync(user.SiteId, dept, user, expand);
        ...
        public async Task<Department> GetDepartmentMTBV1(string dept, string filter = "")
        {
            var userId = _authUtil.GetAuthenticatedUserId(User);
            var user = await _userManager.GetUserByIdAsync(userId);
            var result = await _siteManager.GetDepartmentByKeyForMTBAsync(user.SiteId, dept, user, filter);
        ...
        public async Task<List<Location>> GetLocationsV1()
        {
            var userId = _authUtil.GetAuthenticatedUserId(User);
            var user = await _userManager.GetUserByIdAsync(userId);
            var locations = await _siteManager.GetAvailableLocationsBySiteIdAsync(user.SiteId);
        ...
        public async Task<ClinicalPathway> GetOrderPathwaysV1(int pathwayNum)
        {
            ...
            {
                var groups = await _siteManager.GetPathway(user.SiteId, pathwayNum);
                return groups;
            }
        ...
        public async Task<List<Group>> GetMedPathwaysV1()
        {
            ...
            {
                var pathways = await _siteManager.GetMedPathwaysBySiteIdAsync(user.SiteId);
                return pathways;
            }
        ...
        public async Task<Dictionary<string, MetaData>> GetMedMetaDataV1()
        {
            ...
            if (user.HasAtLeastReadPermission(Permission.MED_SVC))
            {
                var meta = await _siteManager.GetMedMetaDataBySiteIdAsync(user.SiteId);
                return meta;
            }
        ...
        public async Task<List<string>> SearchMedBrandsV1([FromUri]string brand)
        {
            ...
            if (user.HasAtLeastReadPermission(Permission.MED_SVC))
            {
                var meds = await _siteManager.SearchMedicationBrandsBySiteIdAsync(user.SiteId, brand);
                return meds;
            }
        ...
        public async Task<List<Group>> GetOrderPathwaysV1()
        {
            ...
            {
                var pathways = await _siteManager.GetOrderPathwaysBySiteIdAsync(user.SiteId);
                return pathways;
            }
        ...
        public async Task<List<ClinicalPathway>> SearchClinicalPathwaysV1(string name, int limit = 100)
        {
            ...
            if (user.CanNavigateTo(Navigation.Constants.ORDERS))
            {
                var pathways = await _siteManager.SearchClinicalPathwaysBySiteIdAsync(user.SiteId, name, limit);
                return pathways;
            }
        ...
        public async Task<List<Location>> GetDeptLocationsV1(string dept)
        {
            var userId = _authUtil.GetAuthenticatedUserId(User);
            var user = await _userManager.GetUserByIdAsync(userId);
            var locations = await _siteManager.GetAvailableLocationsBySiteIdAsync(user.SiteId, dept);
        ...
        public async Task<List<Location>> GetSharingOptionsV1(string dept)
        {
            var userId = _authUtil.GetAuthenticatedUserId(User);
            var user = await _userManager.GetUserByIdAsync(userId);
            var locations = await _siteManager.GetShareLocationsBySiteIdAsync(user.SiteId, dept);
        ...
        public async Task<Dictionary<string, string>> GetSignupV1()
        {
            var userId = _authUtil.GetAuthenticatedUserId(User);
            var user = await _userManager.GetUserByIdAsync(userId);
            var info = await _siteManager.GetSignupInfo(user.SiteId, user);
