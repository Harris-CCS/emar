...
namespace PulseCheck.Utilities
{
    ...
    public static class Timers
    {
        ...
        public static int CreateTimer(string timerName, IPatient patient, IUser user)
        {
            ...
            var description = timerInfo[Constants.DESCRIPTION];
            ...
            var thruDate = DateTime.Now;

            var time = new Time();
            var mins = time.DiffMinutes(patient.Ibex, time.DateTimeToString(thruDate));

            // Create dictionary with info for the transaction
            Dictionary<string, object> Values = new Dictionary<string, object> {
                { Transaction.Constants.Date, patient.Ibex },
                { Transaction.Constants.Name, timerInfo[Constants.DESCRIPTION] },
                { Transaction.Constants.Service, timerService },
                { Transaction.Constants.Type, Constants.AUTO_TIMER_TYPE },
                { Transaction.Constants.ThruDate, thruDate },
                { Transaction.Constants.Minutes, mins }
            };
