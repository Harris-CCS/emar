...
using Procedure = PulseCheck.QCPR.Data.AccessObject.Procedure;

namespace PulseCheck.QCPR.Data.Tests.Integration
{
    [TestClass]
    public class ImportRepositoryTests
    {
        ...
        private static IImportRepository _importRepository;
        private static IIbexArchiveConnectionSettings _ibexArchiveConnectionSettings;
        ...
        public static void Init(TestContext testContext)
        {
            ...
            _ibexArchiveConnectionSettings = new IbexArchiveConnectionSettings(conncetionString, providername);

            Assert.IsNotNull(_ibexArchiveConnectionSettings);

            _importRepository = new ImportRepository(_ibexArchiveConnectionSettings);

            Assert.IsNotNull(_importRepository);
        ...
        [TestMethod]
        public void SaveImportData_Param_Procedures_Null()
        {
            _importRepository.SaveImportData(null);
        }

        [ExpectedException(typeof(ArgumentOutOfRangeException))]
        [TestMethod]
        public void SaveImportData_Param_Procedures_EmptyList()
        {
            List<Procedure> procedures = new List<Procedure>();

            _importRepository.SaveImportData(procedures.ToArray());
        }

        [TestMethod]
        public void SaveImportData_Param_Procedures_FullData()
        {
            ...
            qcprManager.SaveImportData(_jsonData);
        }

        [ExpectedException(typeof(ArgumentNullException))]
        [TestMethod]
        public void ArchiveJson_Param_Json_Null()
        {
            _importRepository.ArchiveJson(null);
        }

        [TestMethod]
        public void ArchiveJson_Param_Json_Success()
        {
            _importRepository.ArchiveJson(_jsonData);
        }
