...
namespace PulseCheck.QCPR.Logic.Tests
{
    ...
    public class QcprManagerTests
    {
        ...
        {
            _qcprManager.GetProductsByName(0, null);
        }
        ...
        public void GetProductsByName_Param_Name_Success()
        {
            ...
            var result = _qcprManager.GetProductsByName(40, "Aceta");//TODO: use a setting for the site number
        ...
        {
            var result = _qcprManager.GetProceduresByName(40, "Aceta"); //TODO: use a setting for the site number
            Assert.IsNotNull(result);
        }
        ...
        public void GetVendorQcprData()
        {
            ...
            Assert.IsNotNull(result);
            _qcprManager.SaveImportData(result);
