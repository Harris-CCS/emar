...
insert into [#table_order] values(0,5,'dbo','options',0);
insert into [#table_order] values(0,6,'dbo','permissions',0);
insert into [#table_order] values(0,7,'dbo','prompt_groups',0);
insert into [#table_order] values(0,8,'dbo','sites',0);
insert into [#table_order] values(0,9,'dbo','templates',0);
insert into [#table_order] values(1,1,'dbo','medication_routes',0);
insert into [#table_order] values(1,2,'dbo','medication_units',0);
insert into [#table_order] values(1,3,'dbo','override_reasons',0);
insert into [#table_order] values(1,4,'dbo','patients',0);
insert into [#table_order] values(1,5,'dbo','prompts',0);
insert into [#table_order] values(1,6,'dbo','site_code_shares',0);
insert into [#table_order] values(1,7,'dbo','site_formulary',0);
insert into [#table_order] values(1,8,'dbo','site_formulary_match',0);
insert into [#table_order] values(1,9,'dbo','site_options',0);
insert into [#table_order] values(1,10,'dbo','template_prompt_groups',0);
insert into [#table_order] values(1,11,'dbo','users',0);
...
insert into [#table_order] values(2,4,'dbo','patient_allergies',0);
insert into [#table_order] values(2,5,'dbo','patient_home_medications',0);
insert into [#table_order] values(2,6,'dbo','patient_indicators',0);
insert into [#table_order] values(2,7,'dbo','patient_orders',0);
insert into [#table_order] values(2,8,'dbo','prompt_choices',0);
insert into [#table_order] values(2,9,'dbo','user_permissions',0);
insert into [#table_order] values(2,10,'dbo','user_quick_list_items',0);
