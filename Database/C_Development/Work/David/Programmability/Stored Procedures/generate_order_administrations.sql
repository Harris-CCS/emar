...
input parameters are provided for special situational cases
    ...
    , @is_debug
        This parameter prvides some siple output used to generate order_administrations: usefull for debugging
*************************************************************************************************************/
    begin
        declare 
...
**********************************************************************/
        ...
        for select distinct top 10 [pending_orders].[frequency_schedule_id]
