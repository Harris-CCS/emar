...
insert into [#table_order] values(2,13,'dbo','prompt_choices',0);
insert into [#table_order] values(2,14,'dbo','user_permissions',0);
insert into [#table_order] values(2,15,'dbo','user_quick_list_items',0);
