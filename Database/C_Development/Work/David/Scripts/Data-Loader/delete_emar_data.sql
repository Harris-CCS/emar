...
insert into [#table_order] values(1,6,'dbo','medications',0);
insert into [#table_order] values(1,7,'dbo','order_instructions',0);
insert into [#table_order] values(1,8,'dbo','override_reasons',0);
insert into [#table_order] values(1,9,'dbo','patients',0);
insert into [#table_order] values(1,10,'dbo','prompts',0);
insert into [#table_order] values(1,11,'dbo','site_code_shares',0);
...
insert into [#table_order] values(2,5,'dbo','medication_details',0);
insert into [#table_order] values(2,6,'dbo','medication_interactions',0);
...
insert into [#table_order] values(2,10,'dbo','patient_orders',0);
insert into [#table_order] values(2,11,'dbo','patient_problems',0);
insert into [#table_order] values(2,12,'dbo','preferred_frequency_schedules',0);
insert into [#table_order] values(2,13,'dbo','preferred_medication_doses',0);
insert into [#table_order] values(2,14,'dbo','preferred_medication_routes',0);
...
insert into [#table_order] values(2,19,'dbo','user_permissions',0);
