...
add constraint [FK_order_reactions_override_reasons] foreign key([override_reason_id]) references [dbo].[override_reasons]([id]);

go

alter table [dbo].[order_reactions]
add constraint [FK_order_reactions_patient_allergies] foreign key([patient_allergy_id]) references [dbo].[patient_allergies]([id]);

go

alter table [dbo].[order_reactions]
add constraint [FK_order_reactions_patient_cart_orders] foreign key([patient_cart_order_id]) references [dbo].[patient_cart_orders]([id]);

go

alter table [dbo].[order_reactions]
add constraint [FK_order_reactions_patient_orders] foreign key([patient_order_id]) references [dbo].[patient_orders]([id]);

go

alter table [dbo].[order_reactions]
add constraint [FK_order_reactions_users] foreign key([override_reason_user_id]) references [dbo].[users]([id]);
