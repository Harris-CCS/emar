...
backup database [ibex_sample] to disk = N'$(current_path)\..\Scripts\Data-Loader\sample_data\ibex_sample.bak' with blocksize = 65536, maxtransfersize = 1048576, init, compression, stats = 9, copy_only;