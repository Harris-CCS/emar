...
"%pgm_sqlpackage%" /Action:Export /Quiet:False /SourceServerName:"%server_name%" /SourceDatabaseName:"%source_database_name%" /TargetFile:"emar.bacpac" /OverwriteFiles:True
pause
