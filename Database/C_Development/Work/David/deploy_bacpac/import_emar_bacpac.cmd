...
"%pgm_sqlpackage%" /Action:Publish /Quiet:False /SourceFile:"emar.dacpac" /TargetServerName:"%server_name%" /TargetDatabaseName:"%target_database_name%" /Variables:load_data=none /Variables:is_bacpac_build=false /Variables:current_path=xx
pause