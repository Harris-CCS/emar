...
insert into [#table_order] values(0,5,'dbo','medication_routes',0);
insert into [#table_order] values(0,6,'dbo','options',0);
insert into [#table_order] values(0,7,'dbo','permissions',0);
insert into [#table_order] values(0,8,'dbo','prompt_groups',0);
insert into [#table_order] values(0,9,'dbo','sites',0);
insert into [#table_order] values(0,10,'dbo','templates',0);
...
insert into [#table_order] values(2,1,'dbo','cart_order_administrations',0);
insert into [#table_order] values(2,2,'dbo','patient_allergies',0);
insert into [#table_order] values(2,3,'dbo','patient_home_medications',0);
insert into [#table_order] values(2,4,'dbo','patient_indicators',0);
insert into [#table_order] values(2,5,'dbo','patient_orders',0);
insert into [#table_order] values(2,6,'dbo','prompt_choices',0);
insert into [#table_order] values(2,7,'dbo','user_permissions',0);
insert into [#table_order] values(2,8,'dbo','user_quick_list_items',0);
