...
insert into [#table_order] values(2,10,'dbo','prompt_choices',0);
insert into [#table_order] values(2,11,'dbo','user_permissions',0);
insert into [#table_order] values(2,12,'dbo','user_quick_list_items',0);
