...
insert into [#table_order] values(1,3,'dbo','medication_routes',0);
insert into [#table_order] values(1,4,'dbo','medication_units',0);
insert into [#table_order] values(1,5,'dbo','override_reasons',0);
