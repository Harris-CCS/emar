...
*/
    ...
    delete [dbo].[prompt_choices];
    delete [dbo].[user_permissions];
    delete [dbo].[user_quick_list];
    delete [dbo].[action_route_templates];
    ...
    delete [dbo].[template_prompt_groups];
    delete [dbo].[users];
    delete [dbo].[actions];
    delete [dbo].[medication_routes];
    delete [dbo].[options];
    delete [dbo].[permissions];
    delete [dbo].[prompt_groups];
    delete [dbo].[sites];
    delete [dbo].[templates];
    ...
    dbcc checkident('[dbo].[prompt_choices]',reseed,1) with no_infomsgs;
    ...
    dbcc checkident('[dbo].[action_route_templates]',reseed,1) with no_infomsgs;
    dbcc checkident('[dbo].[override_reasons]',reseed,1) with no_infomsgs;
    dbcc checkident('[dbo].[patients]',reseed,1) with no_infomsgs;
    dbcc checkident('[dbo].[prompts]',reseed,1) with no_infomsgs;
    ...
    dbcc checkident('[dbo].[template_prompt_groups]',reseed,1) with no_infomsgs;
    ...
    dbcc checkident('[dbo].[prompt_groups]',reseed,1) with no_infomsgs;
    dbcc checkident('[dbo].[sites]',reseed,1) with no_infomsgs;
    dbcc checkident('[dbo].[templates]',reseed,1) with no_infomsgs;
