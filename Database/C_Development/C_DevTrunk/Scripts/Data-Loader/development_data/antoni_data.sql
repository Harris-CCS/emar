...
declare @med_1 int,@med_2 int

select @med_1=id from dbo.medications
where display_name='ondansetron 8 mg disintegrating tablet'
select @med_2=id from dbo.medications
where display_name='ondansetron 4 mg disintegrating tablet'
...
insert into [dbo].[patient_orders]([patient_id], [add_datetime], [add_user_id], [order_physician_user_id], [priority], [prn], [point_in_time], [order_status], [begin_datetime], [end_datetime], [frequency_schedule_id], [medication_route_id], [order_notes],[medication_id])
values(1, '2020-06-19T17:00:00+05:00', 313, 313, 3, 0, 1, N'Pending', '2020-06-19T17:30:00+05:00', null, 8, 3, N'This is a humongous blob of text!!! ?a? ???a ????????!!!',@med_1);


insert into [dbo].[patient_orders]([patient_id], [add_datetime], [add_user_id], [order_physician_user_id], [priority], [prn], [point_in_time], [order_status], [begin_datetime], [end_datetime], [frequency_schedule_id], [medication_route_id], [order_notes],[medication_id])
values(1, '2020-06-19T17:10:00+05:00', 313, 342, 3, 1, 0, N'Pending', '2020-06-19T17:15:00+05:00', null, 5, 2, N'More text!!! ?? ???? ?e?µe??!!!',@med_2);


insert into [dbo].[patient_orders]([patient_id], [add_datetime], [add_user_id], [order_physician_user_id], [priority], [prn], [point_in_time], [order_status], [begin_datetime], [end_datetime], [frequency_schedule_id], [medication_route_id], [order_notes],[medication_id])
values(1, '2020-06-19T17:11:20+05:00', 342, 313, 2, 1, 1, N'Pending', '2020-06-19T17:11:30+05:00', null, 6, 2, N'More more text!!! ?? ???? ???? ?e?µe??!!!',@med_1);


insert into [dbo].[patient_orders]([patient_id], [add_datetime], [add_user_id], [order_physician_user_id], [priority], [prn], [point_in_time], [order_status], [begin_datetime], [end_datetime], [frequency_schedule_id], [medication_route_id], [order_notes],[medication_id])
values(2, '2020-06-20T08:00:00+05:00', 313, 313, 1, 0, 0, N'Pending', '2020-06-20T08:00:23+05:00', null, 4, 3, N'Is this the end? ?d? e??a? t? t????;',@med_2);

/***********************************************************************************************************************************************************************/

insert into [dbo].[order_administrations]([patient_order_id], [point_in_time], [on_hold], [missed_dose], [administration_scheduled_datetime], [administration_system_datetime], [administration_datetime], [administering_user_id], [stop_scheduled_datetime], [stop_input_datetime], [stop_datetime], [stop_user_id], [acknowledge_user_id], [acknowledge_datetime])
...
([patient_id],[user_id],[add_datetime],[dose],[medication_unit_id],[medication_route_id],[priority],[frequency_schedule_id],[prn],[point_in_time],[begin_datetime],[end_datetime],[order_notes],[user_quick_list_item_id],[medication_id])
OUTPUT inserted.id INTO @IdentityOutput
VALUES
(56,1,'2020-09-22',NULL,NULL,NULL,3,NULL,1,1,'2020-09-22',NULL,NULL,NULL,@med_1)
...
OUTPUT inserted.id INTO @IdentityOutput
VALUES
(56,1,'2020-09-22',NULL,NULL,NULL,3,NULL,1,1,'2020-09-22',NULL,NULL,NULL,@med_2)
...
([patient_id],[user_id],[add_datetime],[dose],[medication_unit_id],[medication_route_id],[priority],[frequency_schedule_id],[prn],[point_in_time],[begin_datetime],[end_datetime],[order_notes],[user_quick_list_item_id],[medication_id])
VALUES
(163,240,'2020-09-23',NULL,NULL,NULL,3,NULL,1,0,'2020-09-23',NULL,NULL,NULL,@med_2)
...
OUTPUT inserted.id INTO @IdentityOutput
VALUES
(56,1,'2020-09-21',NULL,NULL,NULL,2,NULL,0,1,'2020-09-21',NULL,NULL,NULL,@med_1)
...
([patient_id],[user_id],[add_datetime],[dose],[medication_unit_id],[medication_route_id],[priority],[frequency_schedule_id],[prn],[point_in_time],[begin_datetime],[end_datetime],[order_notes],[user_quick_list_item_id],[medication_id])
VALUES
(163,240,'2020-09-20',NULL,NULL,NULL,1,NULL,0,0,'2020-09-20',NULL,NULL,NULL,@med_2)
